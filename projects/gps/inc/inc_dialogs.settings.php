...
<div id="dialog_settings_subaccount_properties" title="<? echo $la['SUB_ACCOUNT_PROPERTIES'];?>">
	<div class="row">
		...
		<div class="block width50">
			<div class="container last">
				...
				<div class="row2">
					<div class="width40"><? echo $la['DIAGNOSTIC_TROUBLE_CODES']; ?></div>
					<div class="width10"><input id="dialog_settings_subaccount_dtc" type="checkbox" checked="checked"/></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="row2">
			<div class="width20"><? echo $la['URL_DESKTOP']; ?></div>
			<div class="width80">
	...
	<div id="settings_event">
		...
		<div id="settings_event_main">
			<div class="row">
				...
				<div class="row2">
					<div class="width50"><? echo $la['PARAMETERS_AND_SENSORS']; ?></div>
					<div class="width50">
				...
				<div class="row2">
					...
					<div class="width1"></div>
					<div class="width9">
						<input id="dialog_settings_event_param_sensor_condition_add" style="min-width: 0;" class="width100 button icon-new icon" type="button" value="<? echo $la['ADD']; ?>" onclick="settingsEventConditionAdd();" disabled />
					</div>
				</div>
			</div>
		</div>
