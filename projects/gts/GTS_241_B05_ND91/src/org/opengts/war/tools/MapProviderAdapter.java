    ...
    implements MapProvider
{
    ...
    **/
    protected String getMapCellStyle(RequestProperties reqState, MapDimension mapDim)
    {
        ...
        return "padding:0px; margin:0px; width:100%; height:" + styleH + ";";
    }
    ...
    **/
        ...
        throws IOException
    {
        ...
        /* write map data */
        System.out.println("Start WriteMaps");
        this.writeMapUpdate(
            out, 0, 
    ...
    **/
        ...
        throws IOException
    {
    	...
    	//System.out.println("Write MapUpdate");
       ...
       // System.out.println("Next 3");
        ...
        try {
          ...
          //  System.out.println("Next 3.2");
        } catch (IOException ioe) {
            Print.logException("Error writing events", ioe);
            out.println("\nError writing Events"); // output is Mime type plain
        }
       // System.out.println("Time to end of process: "+(System.currentTimeMillis()/1000L-startTime) );
    }
