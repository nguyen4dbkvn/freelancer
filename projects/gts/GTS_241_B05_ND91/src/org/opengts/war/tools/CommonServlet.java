    ...
    extends HttpServlet
{
   ...
   // public static final String CSS_TEXT_INPUT_AccInfo           = "inputText";
//    public static final String CSS_TEXT_READONLY_AccInfo        = "inputTextReadOnly";
    ...
    public static final String CSS_CONTENT_FRAME_REPORT[]       = new String[] { "reportDisplayTable"   , "reportDisplayCell" };
    ...
    public static final String CSS_MENUBAR_OK[]                 = new String[] { "contentTable" , "contentMapTable", "contentMapTableFull","reportDisplayTable" };
        ...
        if (reqState.writePageFrameSection(RequestProperties.PAGE_FRAME_CONTENT)) {
            ...
            if (contents != null) {
                ...
                if (!StringTools.isBlank(tableClass)) {
					...
					if (CommonServlet.CSS_CONTENT_FRAME_REPORT[0].equals(tableClass)) {
                        out.write("<tr>\n");
                        MenuBar.writeTableRow(out, pageName, reqState);
                        out.write("</tr>\n");
                    }
