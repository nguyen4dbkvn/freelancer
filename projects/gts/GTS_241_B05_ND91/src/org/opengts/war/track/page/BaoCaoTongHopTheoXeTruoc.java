...
public class BaoCaoTongHopTheoXeTruoc extends WebPageAdaptor implements Constants {
	...
	public BaoCaoTongHopTheoXeTruoc() {
		this.setBaseURI(RequestProperties.TRACK_BASE_URI());
		this.setPageName(PAGE_MENU_RPT_BAOCAOTONGHOPTHEOXETRUOC);
	...
	public String getMenuName(RequestProperties reqState) {
		return MenuBar.PAGE_MENU_RPT_BAOCAOTONGHOPTHEOXETRUOC;
	}

	public String getMenuDescription(RequestProperties reqState,
			String parentMenuName) {
		PrivateLabel privLabel = reqState.getPrivateLabel();
		I18N i18n = privLabel.getI18N(BaoCaoTongHopTheoXeTruoc.class);
		String devTitles[] = reqState.getDeviceTitles();
		return super._getMenuDescription(reqState, "Tổng hợp trước - Báo cáo tổng hợp theo xe");
	}
	...
	public String getMenuHelp(RequestProperties reqState, String parentMenuName) {
		...
		I18N i18n = privLabel.getI18N(BaoCaoTongHopTheoXeTruoc.class);
		String devTitles[] = reqState.getDeviceTitles();
		return super._getMenuHelp(reqState, "Tổng hợp trước - Báo cáo tổng hợp theo xe");
	}
	...
	public String getNavigationDescription(RequestProperties reqState) {
		...
		I18N i18n = privLabel.getI18N(BaoCaoTongHopTheoXeTruoc.class);
		String devTitles[] = reqState.getDeviceTitles();
		return super._getNavigationDescription(reqState, "Tổng hợp trước - Báo cáo tổng hợp theo xe");
	}
	...
	public String getNavigationTab(RequestProperties reqState) {
		...
		I18N i18n = privLabel.getI18N(BaoCaoTongHopTheoXeTruoc.class);
		String devTitles[] = reqState.getDeviceTitles();
		return super._getNavigationTab(reqState,"Tổng hợp trước - Báo cáo tổng hợp theo xe");
	}
	...
	public String LoadReport(String accid, String tungay, String denngay,
		...
		try {
			...
			strscr = strscr
					...
					+ "<th  class='adminTableHeaderCol_sort'>Tổng cộng</th><th  class='adminTableHeaderCol_sort'>Tổng số lần <br/> vi phạm/1000km xe chạy</th><th  class='adminTableHeaderCol_sort'>Tỷ lệ % km <br/> vi phạm/km xe chạy</th>"
					+ "</tr></thead>";

			rs = objcmr.BCTongHopTheoXeTruoc(accid, device, tungay, denngay,
					timezone);
			String css = "";
			...
			for (int j = 0; j < rs.size(); j++) {
				try {
					...
					strscr = strscr
							...
							+ "<td>" + 0 + "</td><td>" + 0 + "</td><td>"
							+ rs.get(j).TongDungDo + "</td>" + "<td>" + rs.get(j).decription
							+ "</td></tr>";
				} catch (Exception e) {
					strscr += e.getMessage();
				}
	...
	public void writePage(final RequestProperties reqState, String pageMsg)
		...
		HTMLOutput HTML_CSS = new HTMLOutput() {
			public void write(PrintWriter out) throws IOException {
				String cssDir = BaoCaoTongHopTheoXeTruoc.this.getCssDirectory();
		...
		HTMLOutput HTML_CONTENT = new HTMLOutput(
			...
			public void write(PrintWriter out) throws IOException {
				...
				out.println("<span class='"
						...
						+ "' style='text-align:center;'>BÁO CÁO TỔNG HỢP THEO XE TRƯỚC</span><br/>");
				out.println("<hr/>");
