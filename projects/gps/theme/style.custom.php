<?
	...
	// #################################################
        ...
        {
                $style .= 'body#login { background: '.$theme["login_bg_color"].'; }';
        }
        
        // login bg color
        if (isset($theme['login_dialog_bg_color']))
        {
                $style .= '#login .wrapper .inner-wrapper { background: '.$theme["login_dialog_bg_color"].'; }';
        }
	...
	// #################################################
        ...
        if (isset($theme['ui_top_panel_color']))
        {
                ...
                $style .= '#top_panel .chat-msg-count { color: '.$theme["ui_top_panel_color"].'; }';
                $style .= '#top_panel .billing-plan-count { color: '.$theme["ui_top_panel_color"].'; }';
        }
        ...
        if (isset($theme['ui_top_panel_border_color']))
        {
                ...
                $style .= '#top_panel .chat-msg-count { background-color: '.$theme["ui_top_panel_border_color"].'; }';
                $style .= '#top_panel .billing-plan-count { background-color: '.$theme["ui_top_panel_border_color"].'; }';
        }
        
        // top panel selection color
        if (isset($theme['ui_top_panel_selection_color']))
        {
                $style .= '#top_panel ul li:hover { background-color: '.$theme["ui_top_panel_selection_color"].'; }';
                $style .= '#top_panel ul li a.active { background-color: '.$theme["ui_top_panel_selection_color"].'; }';        
        }
        ...
        if (isset($theme['ui_accent_color_1']))
        {
                ...
                $style .= '#top_panel .map-btn { background-color: '.$theme["ui_accent_color_1"].'; }';
                $style .= '#top_panel .map-btn:hover { background-color: '.$theme["ui_accent_color_1"].'; opacity: 0.9; }';
        ...
        {
                $style .= '#top_panel .cpanel-btn { background-color: '.$theme["ui_accent_color_2"].'; }';
                $style .= '#top_panel .cpanel-btn:hover { background-color: '.$theme["ui_accent_color_2"].'; opacity: 0.9; }';
        }
        
        // accent color 3
        if (isset($theme['ui_accent_color_3']))
        {
                $style .= '#top_panel .billing-btn { background-color: '.$theme["ui_accent_color_3"].'; }';
                $style .= '#top_panel .billing-btn:hover { background-color: '.$theme["ui_accent_color_3"].'; opacity: 0.9; }';
        ...
        {
                $style .= '#top_panel .logout-btn { background-color: '.$theme["ui_accent_color_4"].'; }';
                $style .= '#top_panel .logout-btn:hover { background-color: '.$theme["ui_accent_color_4"].'; opacity: 0.9; }';
        ...
        {
                $style .= '#top_panel ul li a { color: '.$theme["ui_top_panel_font_color"].'; }';     
        }
        
        // top panel counters font color
        if (isset($theme['ui_top_panel_counters_font_color']))
        {
                $style .= '#top_panel .chat-msg-count { color: '.$theme["ui_top_panel_counters_font_color"].'; }';
                $style .= '#top_panel .billing-plan-count { color: '.$theme["ui_top_panel_counters_font_color"].'; }';   
        }
