              ...
              //String menuURL    = EncodeMakeURL(reqState,RequestProperties.TRACK_BASE_URI(),PAGE_MENU_TOP);
                ...
                if (_listZones) {
                    ...
                    if (_allowView  ) { 
                        ...
                        out.write("<input type='submit' name='"+PARM_SUBMIT_VIEW+"' value='"+i18n.getString("ZoneInfo.list.view","View")+"'  class='button'>");
                        out.write("</td>\n"); 
                    }
                    if (_allowEdit  ) { 
                        out.write("<td style='padding-left:5px;'>");
                        out.write("<input type='submit' name='"+PARM_SUBMIT_EDIT+"' value='"+i18n.getString("ZoneInfo.list.edit","Edit")+"'  class='button'>");
                        out.write("</td>\n"); 
                    }
                    out.write("<td style='width:100%; text-align:left; padding-left:5px;'>");
                    if (_allowDelete) { 
                        out.write("<input type='submit' name='"+PARM_SUBMIT_DEL+"' value='"+i18n.getString("ZoneInfo.list.delete","Delete")+"' "+Onclick_ConfirmDelete(locale)+"  class='button'>");
                    } else {
                        out.write("&nbsp;"); 
                    }
                    out.write("</td>\n"); 
                    ...
                    if (_allowNew) {
                      ...
                      //int corrPointCount = (mapProvider != null)? mapProvider.getGeozoneSupportedPointCount(corridorType) : 0;
                        ...
                        out.write("<br>\n");
                        out.write(" <input type='submit' name='"+PARM_SUBMIT_NEW+"' value='"+i18n.getString("ZoneInfo.list.new","New")+"' style='margin-top:5px; margin-left:10px;'  class='button'>\n");
                        out.write("</form>\n");
                        out.write("</div>\n");
                        out.write("<hr>\n");
                    }
                    ...
                    out.write("<td nowrap style='padding-left:10px;'>");
                    ...
                    out.write("</td>");
                    out.write("<td nowrap style=\" padding-left:50px;\">");
                    ...
                    out.println("<table border='0' cellpadding='0' cellspacing='0' style='padding-left:10px; padding-bottom:10px; padding-top:10px; width:100%'>"); // {
                    out.println("<tr>");
                    ...
                    if (!mapControlsOnLeft) {
                        if (mapSupportsGeozones) {
                            out.println("<td style=' height:"+mapDim.getHeight()+"px; padding-right:35px; width:80%'>");
                            out.println("<!-- Begin Map -->");
                            mapProvider.writeMapCell(out, reqState, mapDim);
                            out.println("<!-- End Map -->");
                            out.println("</td>");
                        } else {
                            out.println("<td style=' height:"+mapDim.getHeight()+"px; padding-right:5px; border: 1px solid black;width:82%'>");
                    ...
                    if (_editZone && mapSupportsGeozones) {
                        ...
                        out.print("<input class='formButton' type='button' name='reset' value='"+i18nResetBtn+"' title=\""+i18nResetTooltip+"\" onclick=\"javascript:_zoneReset();\" class='button'>");
                    }
                    out.println("<br>");
                  //int pointCount = (mapProvider != null)? mapProvider.getGeozoneSupportedPointCount(selZoneType) : 0;
                    ...
                    if (_editZone) {
                        ...
                        out.write("<input type='submit' name='"+PARM_SUBMIT_CHG+"' value='"+i18n.getString("ZoneInfo.map.change","Change")+"'  class='button'>\n");
                     
                        
                       
                        out.write("<span style='padding-left:10px'>&nbsp;</span>\n");
                        out.write("<input type='button' name='"+PARM_BUTTON_CANCEL+"' value='"+i18n.getString("ZoneInfo.map.cancel","Cancel")+"' onclick=\"javascript:openURL('"+editURL+"','_self');\"  class='button'>\n"); // target='_top'
                      
                    } else {
                    	
                        out.write("<input type='button' name='"+PARM_BUTTON_BACK+"' value='"+i18n.getString("ZoneInfo.map.back","Back")+"' onclick=\"javascript:openURL('"+editURL+"','_self');\"  class='button'>\n"); // target='_top'
