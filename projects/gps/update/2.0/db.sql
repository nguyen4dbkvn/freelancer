...
--
-- Table structure for table `gs_tracker_cmd_exec`
--

CREATE TABLE IF NOT EXISTS `gs_tracker_cmd_exec` (
...
CREATE TABLE IF NOT EXISTS `gs_user_cmd` (
  ...
  `cmd` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`cmd_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;
