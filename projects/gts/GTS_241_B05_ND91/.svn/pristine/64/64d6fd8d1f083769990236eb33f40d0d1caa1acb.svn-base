    ...
    extends GroupRecord<DeviceGroup>
{
    ...
    public static DeviceGroup getDeviceGroup(Account account, String groupId,String displayName, boolean createOK)
    		throws DBException
    		    {
    		        // does not return null, if 'createOK' is true
    ...
    public static DeviceGroup createNewDeviceGroup(Account account, String groupID, String displayName)
            throws DBException
        {
            if ((account != null) && (groupID != null) && !groupID.equals("")) {
                DeviceGroup group = DeviceGroup.getDeviceGroup(account, groupID,displayName, true); // does not return null
                group.save();
                return group;
            } else {
                throw new DBException("Invalid Account/GroupID specified");
