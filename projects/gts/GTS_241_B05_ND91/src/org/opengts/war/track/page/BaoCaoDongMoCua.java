    ...
    implements Constants
{
   ...
   // public  static final String PARM_FORMAT[]               = ReportMenu.PARM_FORMAT;
    ...
    public BaoCaoDongMoCua()
    {
    	 this.setBaseURI(RequestProperties.TRACK_BASE_URI());
        this.setPageName(PAGE_BAOCAODONGMOCUA);
    ...
    public String getMenuDescription(RequestProperties reqState, String parentMenuName)
    {
        ...
        I18N i18n = privLabel.getI18N(BaoCaoDongMoCua.class);
        return super._getMenuDescription(reqState,i18n.getString("BaoCaoDongMoCua.Menu","Báo cáo mở cửa"));
    }
    ...
    public String getMenuHelp(RequestProperties reqState, String parentMenuName)
    {
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(BaoCaoDongMoCua.class);
        return super._getMenuHelp(reqState,i18n.getString("BaoCaoDongMoCua.MenuHelp","Báo cáo bật điều khiển cần cẩu"));
    }
    ...
    public String getNavigationDescription(RequestProperties reqState)
    {
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(BaoCaoDongMoCua.class);
        return super._getNavigationDescription(reqState,i18n.getString("BaoCaoDongMoCua.NavDesc","Báo cáo bật điều khiển cần cẩu"));
    }
    ...
    public String getNavigationTab(RequestProperties reqState)
    {
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(BaoCaoDongMoCua.class);
        return i18n.getString("BaoCaoDongMoCua.NavTab","Báo cáo bật điều khiển cần cẩu");
    }
    ...
    public String LoadMocua(String Account, String tuNgay, String denNgay,String Device,PrivateLabel privLabel,RequestProperties reqState,String timezone) throws IOException
    {
    	int dem=0;
    	...
    	try
    	{
            ...
            IDDescription list[] = idList.toArray(new IDDescription[idList.size()]);
	    		...
	    		strscr =strscr+ "<table  class='adminSelectTable_sortable' cellspacing='1' id='myTable' ><thead><tr  align='center'><th width='50px' class='adminTableHeaderCol_sort' >STT</th><th  class='adminTableHeaderCol_sort'>Thời gian bắt đầu</th><th  class='adminTableHeaderCol_sort'>Thời gian kết thúc</th><th  class='adminTableHeaderCol_sort'>Địa điểm bắt đầu</th><th class='adminTableHeaderCol_sort'>Địa điểm kết thúc</th></tr></thead>";
	    		if(Device.equals("-1"))
	    		{
	    		for(int d=0;d<list.length;d++)
	    		{
	    			ArrayList<MoCua> listreport = objcmr.StaticReportMoCua(Account, list[d].getID(), tuNgay, denNgay, timezone);
	    			
	    			if(listreport.size()>0)
	    			{
	    				strscr=strscr+"<tr style='height:30px;color:black'><td colspan='5' align='left'><span style='margin-left:25px;'><b>"+list[d].getID()+"</b></span></td></tr>";	
	    			}
		    		...
		    		{			
		    			...
		    			strscr=strscr+"<tr class ="+css+"><td>"+(k+1)+"</td><td>"+ConvertFromEpoch(listreport.get(k).getstartTime(), timezone)+"</td><td>"+ConvertFromEpoch(listreport.get(k).getendTime(), timezone) +"</td><td>"+listreport.get(k).getaddress()+"</td><td>"+listreport.get(k).getendaddress()+"</td></tr>";	
		    			dem++;
		    			record++;
		    		}
	    		}
	    		...
	    		{
	    			ArrayList<MoCua> listreport = objcmr.StaticReportMoCua(Account, Device, tuNgay, denNgay, timezone);
	    			if(listreport.size()>0)
	    			{
	    			strscr=strscr+"<tr style='height:30px;color:black'><td colspan='5' align='left'><span style='margin-left:25px;'><b>"+Device+"</b></span></td></tr>";	
	    			}
	    			for(int k=0;k<listreport.size();k++)
		    		{			
		    			String css ="";
   ...
   public void writePage(
        ...
        throws IOException
    {
       ...
       final I18N    i18n     = privLabel.getI18N(BaoCaoDongMoCua.class);
       ...
       // contentall = AttributeTools.getRequestString(request, "device", "");
        ...
        if(excel!=""){
        	...
        	{  
        	 ...
        	 response.setContentType("application/vnd.ms-excel;charset=utf-8");
              response.setHeader("Content-Disposition", "attachment; filename=baoCaoDongMo_"+ d + "xls");
              ...
              HSSFWorkbook wb = new HSSFWorkbook();
    			...
    			HSSFCellStyle cst = wb.createCellStyle();
    			 ...
    			 ft.setFontHeightInPoints((short) 18);
    			      ...
    			      //   f.setColor((short) HSSFColor.RED.index);
            			...
            			ct.setCellStyle(cst);
            			ct.setCellValue("BÁO CÁO ĐÓNG MỞ CỬA");
    			...
    			HSSFFont fngay = wb.createFont();
    			  ...
    			  ngay.createCell((short) 4).setCellValue(dateto);
    	      ...
    	      // rowhead.createCell((short) 0).setCellValue("STT");
    	        ...
    	        HSSFCell h3=rowhead.createCell((short) 3);
    	        	...
    	        	h3.setCellValue("Địa điểm bắt đầu");
    	        HSSFCell h4=rowhead.createCell((short) 4);
    	        	h4.setCellStyle(cellStyle);
    	            h4.setCellValue("Địa điểm kết thúc");
        	     ...
        	     rowhead.setHeightInPoints((short)40);
          		...
          		try{
                    ...
                    IDDescription list[] = idList.toArray(new IDDescription[idList.size()]);
        	    		...
        	    		{
        	    			ArrayList<MoCua> listreport = objcmr.StaticReportMoCua(currAcct.getAccountID(), list[d1].getID(), datefrom, dateto, currAcct.getTimeZone());
        	    			dem++;
                      		HSSFRow row1 = sheet.createRow((short)dem);
        			row1.setHeightInPoints(25);
        			sheet.addMergedRegion(new CellRangeAddress(dem, dem, 0, 4));
        			...
        			//row1.setRowStyle(cellStyle);
          			...
          			for(int i =0;i<listreport.size();i++)	
          			{
          				dem++;
          				num++;
          				//chuoi1=chuoi1+"<tr class ="+css+"><td>"+num+"</td><td> "+rs.getString(6)+"</td><td>"+rs.getString(3)+"</td><td>"+doiGio(Integer.parseInt( rs.getString(4)))+"</td><td>"+ DungDo(Integer.parseInt(rs.getString(4))) +"</td><td>"+rs.getString(5)+"</td></tr>";	
            			...
            			csr.setBorderBottom((short)1);
          				...
          				r1.setCellStyle(csr);		
          				r1.setCellValue(ConvertFromEpoch(listreport.get(i).getstartTime(), currAcct.getTimeZone()));
        	        	//row.createCell((short) 2).setCellValue(rs.getString(4));
          				HSSFCell r2=row.createCell((short) 2);
          				r2.setCellStyle(csr);
          				r2.setCellValue(ConvertFromEpoch(listreport.get(i).getendTime(), currAcct.getTimeZone()));
          				
          				HSSFCell r3=row.createCell((short) 3);
          				r3.setCellStyle(csr);
          				r3.setCellValue(NCRToUnicode(listreport.get(i).getaddress()));
          				HSSFCell r4=row.createCell((short) 4);
          				r4.setCellStyle(csr);
          				r4.setCellValue(NCRToUnicode(listreport.get(i).getendaddress()));
        	        //	row.createCell((short) 6).setCellValue(GetUTF8FromNCRDecimalString(rs.getString(5)));
        	    		...
        	    		{
        	    			ArrayList<MoCua> listreport = objcmr.StaticReportMoCua(currAcct.getAccountID(),contentall, datefrom, dateto, currAcct.getTimeZone());
        	    			dem++;
                      		HSSFRow row1 = sheet.createRow((short)dem);
        			row1.setHeightInPoints(25);
        			sheet.addMergedRegion(new CellRangeAddress(dem, dem, 0, 4));
        ...
        HTMLOutput HTML_CSS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                String cssDir = BaoCaoDongMoCua.this.getCssDirectory();
        ...
        HTMLOutput HTML_CONTENT  = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
            public void write(PrintWriter out) throws IOException {
                ...
                String frameTitle = "Báo cáo bật điều khiển cần cẩu";
                HttpServletRequest request = reqState.getHttpServletRequest();
                String contentall = "";
             ...
             // view submit
                ...
                String sql = LoadMocua(currAcct.getAccountID(),datefrom, dateto,contentall,privLabel,reqState,currAcct.getTimeZone());
                ...
                out.println("<span class='"+CommonServlet.CSS_MENU_TITLE+"'>Báo cáo bật điều khiển cần cẩu</span><br/>");
                out.println("<hr/>");
                out.println("<form name='baocaodongmocua' method='post' action='"+chgURL+"' target='_self'>\n");
                ...
                out.print  ("<input id='datefrom' class='textReadOnly' name='datefrom' type='text' style='width:120px' onclick=\"displayCalendar(this,'dd/mm/yyyy hh:ii',this,true,'','datefrom')\" value='"+d+" 00:00' />");
                if(datefrom!="")
				{
              ...
              //  out.print("</tr>");
               ...
               // out.print("<tr style='height:40px'>");
                ...
                out.print("<td>");
                out.print( "<input id='dateto' class='textReadOnly' name='dateto' type='text' style='width:120px' onclick=\"displayCalendar(this,'dd/mm/yyyy hh:ii',this,true,'','dateto')\" value='"+d+" 23:59' />");
                if(dateto!="")
				{
