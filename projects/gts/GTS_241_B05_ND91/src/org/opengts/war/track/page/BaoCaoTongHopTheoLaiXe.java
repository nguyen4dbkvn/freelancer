...
public class BaoCaoTongHopTheoLaiXe extends WebPageAdaptor implements Constants {
	...
	public BaoCaoTongHopTheoLaiXe() {
		this.setBaseURI(RequestProperties.TRACK_BASE_URI());
		this.setPageName(PAGE_MENU_RPT_BAOCAOTONGHOPTHEOLAIXE);
	...
	public String getMenuName(RequestProperties reqState) {
		return MenuBar.PAGE_MENU_RPT_BAOCAOTONGHOPTHEOLAIXE;
	}

	public String getMenuDescription(RequestProperties reqState,
			String parentMenuName) {
		PrivateLabel privLabel = reqState.getPrivateLabel();
		I18N i18n = privLabel.getI18N(BaoCaoTongHopTheoLaiXe.class);
		String devTitles[] = reqState.getDeviceTitles();
		return super._getMenuDescription(reqState, i18n.getString(
				"ReportMenuBaoCaoTongHopTheoLaiXe.menuDesc",
				"{0} Detail Reports", "Báo cáo tổng hợp theo lái xe"));
	}
	...
	public String getMenuHelp(RequestProperties reqState, String parentMenuName) {
		...
		return super._getMenuHelp(reqState, i18n.getString(
				"ReportMenuBaoCaoTongHopTheoLaiXe.menuHelp",
	...
	public String getNavigationDescription(RequestProperties reqState) {
		...
		return super._getNavigationDescription(reqState, i18n.getString(
				"ReportMenuBaoCaoTongHopTheoLaiXe.navDesc", "{0}",
				"Báo cáo tổng hợp theo lái xe"));
	}
	...
	public String getNavigationTab(RequestProperties reqState) {
		...
		return super._getNavigationTab(reqState, i18n.getString(
				"ReportMenuBaoCaoTongHopTheoLaiXe.navTab", "{0}",
	...
	public String LoadReport(String accid, String tungay, String denngay,
			String dri, PrivateLabel privLabel, RequestProperties reqState,
		...
		try {
			...
			rs = objcmr.BCTongHopTheoLaiXe(accid, dri, tungay, denngay,
					timezone);
			String css = "";
			...
			for (int j = 0; j < rs.size(); j++) {
				try {
					...
					strscr = strscr
							...
							+ count
							+ "</td><td>"
							+ (rs.get(j).displayName.trim().equals("")?"noName":rs.get(j).displayName.trim())
							+ "</td>"
							+ "<td>"
							+ (rs.get(j).driverLC.trim().equals("")?"0000000000":rs.get(j).driverLC.trim())
							+ "</td>"
							+ "<td>"
							+ df.format(tongKM)
							+ "</td>"
	...
	public void writePage(final RequestProperties reqState, String pageMsg)
		...
		HTMLOutput HTML_CSS = new HTMLOutput() {
			public void write(PrintWriter out) throws IOException {
				String cssDir = BaoCaoTongHopTheoLaiXe.this.getCssDirectory();
		...
		HTMLOutput HTML_JS = new HTMLOutput() {
			...
			/*	out.println("        <script type=\"text/javascript\" src=\"js/jspdf.js\"></script>\n");
				out.println("        <script type=\"text/javascript\" src=\"js/FileSaver.min.js\"></script>\n");
				out.println("        <script type=\"text/javascript\" src=\"js/jspdf.plugin.standard_fonts_metrics.js\"></script>\n");
				out.println("        <script type=\"text/javascript\" src=\"js/jspdf.plugin.split_text_to_size.js\"></script>\n");
				out.println("        <script type=\"text/javascript\" src=\"js/jspdf.plugin.cell.js\"></script>\n"); */
		...
		HTMLOutput HTML_CONTENT = new HTMLOutput(
			...
			public void write(PrintWriter out) throws IOException {
				...
				out.println("<span class='"
						...
						+ "' style='text-align:center;'>BÁO CÁO TỔNG HỢP THEO LÁI XE</span><br/>");
				out.println("<hr/>");
				...
				out.println("</tr>");
				out.println("</table>");
				out.print("<table cellspacing='0' style='width:100%;padding:10px 0px 10px'><tbody><tr class='viewhoz'><td width='80px'></td><td width='100px'> <input type='submit' class='button1' name='btnview' value='Xem' id='btnview'></td><td width='205px'></td><td align='left' width='220px'><input type='button' id='btnExcel' value='Export Excel' name='btnExcel' class='button1' ></td><td align='left'><input type='button' id='exportpdf' value='Export PDF' name='exportpdf' class='button1' ></td>");
