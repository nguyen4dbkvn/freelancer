...
function calWriteCalendars(calFr, calTo)
{
    ...
    if ((calFr != null) && (calTo != null)) {
        ...
        calTo.setExpanded(true   , fade);      // show collapsed minhnv sua thanh true
...
var COLOR_THISDAY_BG    = "transparent";
...
Calendar.prototype.toggleExpand = function()
{
   ...
   this.setExpanded(this.expanded, fade);//minhnv bo dau !
}
...
Calendar.prototype._writeCalendar = function(expanded, calRows)
{
    ...
    var yearName            = (""+this.year).substring(0);
    ...
    if (this.drawClickBar) {
		...
		//minhnv them an;
        calendarHTML += "<tr style='display:none'>";
        if (inTransition) {
            ...
            if (expanded) {
                ...
                calendarHTML += "<td class='"+CLASS_CAL_EXPAND_BAR+"' onclick=\""+clickExpand+"\" >";
            } else {
                clickExpand   = "javascript:"+this.calVarName+".toggleExpand();";
                calendarHTML += "<td class='"+CLASS_CAL_COLLAPSE_BAR+"' onclick=\""+clickExpand+"\" >";
            }
            var dirImage = null
            if (this.drawDivBox) {
    ...
    if (expanded || this.drawFixedExpanded) {
        ...
        calendarHTML += "<td class='"+CLASS_CAL_TITLE_FIELD_EXP+"' style='"+styleCollapse+"'  onclick=\""+clickExpand+"\">"+this.title+"</td>\n";
        calendarHTML += "<td class='"+CLASS_CAL_DATE_TIME_EXP+"' style='"+styleCollapse+"' nowrap >";
    ...
    if (expanded || this.drawFixedExpanded) {
        ...
        if (!this.isSameMonthAsPriorCalendar()) {
            calendarBODY += "<td class='"+CLASS_CAL_MONTH_ADVANCE+"'><b><a href=\"javascript:"+this.calVarName+".gotoPreviousMonth()\" title=\""+TOOLTIP_PREV_MONTH+"\"><img src='./images/left1.gif' /></a></b></td>\n";
        } else {
            calendarBODY += "<td class='"+CLASS_CAL_MONTH_ADVANCE+"'><img src='./images/left1.gif' /></td>\n";
        }
        ...
        if (!this.isSameMonthAsNextCalendar()) {
            calendarBODY += "<td class='"+CLASS_CAL_MONTH_ADVANCE+"'><b><a href=\"javascript:"+this.calVarName+".gotoNextMonth()\" title=\""+TOOLTIP_NEXT_MONTH+"\"><img src='./images/right1.gif' /></a></b></td>\n";
        } else {
            calendarBODY += "<td class='"+CLASS_CAL_MONTH_ADVANCE+"'><img src='./images/right1.gif' /></td>\n";
        }
        calendarBODY += "</tr>\n";
        calendarBODY += "</table>\n";
        calendarBODY += "</td></tr>\n";
        ...
        for (var wdx = 0; wdx < 7; wdx++) {
            ...
            calendarBODY += "<td class='"+CLASS_CAL_MONTH_DOW+"'>" + CalDayNames[wd] + "</td>\n";
        }
        calendarBODY += "</tr>\n";
        ...
        for (var i = 0; i < (calRows * 7);) { // 6 rows of 7 days
            ...
            for (var wdx = 0; wdx < 7; wdx++) {
                ...
                if (d < 0) {
                    ...
                    calendarBODY += "<td class='"+CLASS_CAL_PREV_MONTH_DAYS+"'>"+ds+"</td>\n";
                } else
                if (d >= daysInThisMonth) {
                    // next-month days
                    var ds = (d - daysInThisMonth + 1);
                    calendarBODY += "<td class='"+CLASS_CAL_NEXT_MONTH_DAYS+"'>"+ds+"</td>\n";
                } else {
                    // days in this month
                    var ds = (d + 1);
                    if (this.enabled/* && !inTransition*/) {
                        calendarBODY += "<td class='"+CLASS_CAL_MONTH_DAYS_ENABLE+"' id='"+dayID+"."+ds+"' onclick=\"javascript:"+this.calVarName+".selectDay("+ds+");\">"+ds+"</td>\n";
                    } else {
                        calendarBODY += "<td class='"+CLASS_CAL_MONTH_DAYS_DISABL+"' id='"+dayID+"."+ds+"'>"+ds+"</td>\n";
                    }
                }
                d++;
                i++;
