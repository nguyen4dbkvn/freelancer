...
var dem =0;
   ...
   // document.getElementById('main').style.display ="none";
    ...
    document.getElementById('baoCao').style.display ="none";
    document.getElementById('quanLy').style.display ="none";
    //if(dem%2 ==1)
...
if(typeof(DD_belatedPNG) != 'undefined'){
	DD_belatedPNG.fix('#container ul li ul li');
}	
function minhNVChuyenTrang(url)
{window.location =url;}
