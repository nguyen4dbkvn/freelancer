    ...
    implements Constants
{
    ...
    public String getMenuDescription(RequestProperties reqState, String parentMenuName)
    {
        ...
        I18N i18n = privLabel.getI18N(AccountInfo1.class);
        ...
        throws IOException
    {
        ...
        final I18N    i18n     = privLabel.getI18N(AccountInfo1.class);
        ...
        HTMLOutput HTML_CSS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                String cssDir = AccountInfo1.this.getCssDirectory();
        ...
        HTMLOutput HTML_CONTENT  = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
            public void write(PrintWriter out) throws IOException {
              ...
              //ComboOption geocoderMode     = privLabel.getEnumComboOption(Account.getGeocoderMode(currAcct)    );
               ...
               // out.println(FormRow_TextField(PARM_ACCT_ID     ,i18n.getString("AccountInfo.accountID","Account ID:")       , false     , currAcct.getAccountID(),""       , 40, 32,"inputText")); // read-only
                out.println(FormRow_TextField(PARM_ACCT_ID      , false     , i18n.getString("AccountInfo.accountID","Account ID:")                  , currAcct.getAccountID()       , 40, 32)); // read-only
                ...
                out.println(FormRow_TextField(PARM_CONTACT_PHONE, _allowEdit, i18n.getString("AccountInfo.contactPhone","Contact Phone:")            , currAcct.getContactPhone()    , 40, 20));
                out.println(FormRow_TextField(PARM_CONTACT_EMAIL, _allowEdit, i18n.getString("AccountInfo.contactEMail","Contact Email:")            , currAcct.getContactEmail()    , 40, 100));
                out.println(FormRow_TextField(PARM_NOTIFY_EMAIL , _allowEdit, i18n.getString("AccountInfo.notifyEMail","Notify Email:")              , currAcct.getNotifyEmail()     , 40, 125));
                
                out.println(FormRow_ComboBox (PARM_TIMEZONE     , _allowEdit, i18n.getString("AccountInfo.timeZone","Time Zone:")                    , currAcct.getTimeZone()        , _tzList, null, 40));
               
               
                out.println(FormRow_ComboBox (PARM_SPEED_UNITS  , _allowEdit, i18n.getString("AccountInfo.speedUnits","Speed Units:")                , speedUnits       , _suList, null, 40));
                
                out.println(FormRow_ComboBox (PARM_DIST_UNITS   , _allowEdit, i18n.getString("AccountInfo.distanceUnits","Distance Units:")          , distanceUnits    , _duList, null, 40));
                out.println(FormRow_ComboBox (PARM_VOLM_UNITS   , _allowEdit, i18n.getString("AccountInfo.volumeUnits","Volume Units:")              , volumeUnits      , _vuList, null, 40));
                out.println(FormRow_ComboBox (PARM_ECON_UNITS   , _allowEdit, i18n.getString("AccountInfo.economyUnits","Economy Units:")            , economyUnits     , _ecList, null, 40));
                out.println(FormRow_ComboBox (PARM_PRESS_UNITS  , _allowEdit, i18n.getString("AccountInfo.pressureUnits","Pressure Units:")          , pressureUnits    , _puList, null, 40));
                out.println(FormRow_ComboBox (PARM_TEMP_UNITS   , _allowEdit, i18n.getString("AccountInfo.temperatureUnits","Temperature Units:")    , temperatureUnits , _tuList, null,  40));
                out.println(FormRow_ComboBox (PARM_LATLON_FORMAT, _allowEdit, i18n.getString("AccountInfo.latLonFormat","Latitude/Longitude Format:"), latLonFormat     , _llList, null, 40));
                ...
                out.print  (Form_TextField(PARM_DEVICE_TITLE , _allowEdit, devTitles[0], 40, 40));
                out.print  ("<span style='margin-left: 10px;margin-right:5px;'>"+i18n.getString("AccountInfo.plural","Plural:")+"</span>");
                out.print  (Form_TextField(PARM_DEVICES_TITLE, _allowEdit, devTitles[1], 40, 40));
                out.print  ("</td>");
                out.println("</tr>");
                ...
                out.print  ("<td class='"+CommonServlet.CSS_ADMIN_VIEW_TABLE_DATA+"'>");
                out.print  (Form_TextField(PARM_GROUP_TITLE , _allowEdit, grpTitles[0], 40, 40));
                out.print  ("<span style='margin-left: 10px;margin-right:5px;'>"+i18n.getString("AccountInfo.plural","Plural:")+"</span>");
                out.print  (Form_TextField(PARM_GROUPS_TITLE, _allowEdit, grpTitles[1], 40, 40));
                out.print  ("</td>");
                out.println("</tr>");
                ...
                out.print  ("<td class='"+CommonServlet.CSS_ADMIN_VIEW_TABLE_DATA+"'>");
                out.print  (Form_TextField(PARM_ADDRESS_TITLE  , _allowEdit, adrTitles[0], 40, 40));
                out.print  ("<span style='margin-left: 10px;margin-right:5px;'>"+i18n.getString("AccountInfo.plural","Plural:")+"</span>");
                out.print  (Form_TextField(PARM_ADDRESSES_TITLE, _allowEdit, adrTitles[1], 40, 40));
                out.print  ("</td>");
                out.println("</tr>");
                */
                /* default user */
                out.println(FormRow_TextField(PARM_DEFAULT_USER , _allowEdit, i18n.getString("AccountInfo.defaultUser","Default Login UserID:")      , currAcct.getDefaultUser()     , 40, 32));
                ...
                if (expireTime > 0L) {
                    ...
                    out.println(FormRow_TextField(PARM_ACCT_EXPIRE  , false     , i18n.getString("AccountInfo.expiration","Expiration:")                 , expireTimeStr                 , 40, 30)); // read-only
                }
                ...
                if (_allowEdit) {
                    out.write("<input type='submit' name='"+PARM_SUBMIT_CHANGE+"' value='"+i18n.getString("AccountInfo.change","Change")+"' class='button'>\n");
                    out.write("<span style='padding-left:10px'>&nbsp;</span>\n");
                    out.write("<input type='button' name='"+PARM_BUTTON_CANCEL+"' value='"+i18n.getString("AccountInfo.cancel","Cancel")+"' onclick=\"javascript:openURL('"+menuURL+"','_self');\" class='button'>\n"); // target='_top'
                } else {
                    out.write("<input type='button' name='"+PARM_BUTTON_BACK+"' value='"+i18n.getString("AccountInfo.back","Back")+"' onclick=\"javascript:openURL('"+menuURL+"','_self');\" class='button'>\n"); // target='_top'
                }
                out.write("</form>\n");
