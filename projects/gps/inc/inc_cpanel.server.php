		...
		<div class="block width50">
			<div class="container">
				<div class="row2">
					...
					<div class="width50">
						<select style="width: 100px;" id="dialog_theme_login_dialog_logo_position" />
				...
				<div class="row2">
					...
					<div class="width50">
						<select style="width: 100px;" id="dialog_theme_login_dialog_opacity" />
				...
				<div class="row2">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_login_bg_color'/>
					</div>
				</div>
			</div>
		</div>
		<div class="block width50">
			<div class="container last">
				<div class="row2">
					...
					<div class="width50">
						<select style="width: 100px;" id="dialog_theme_login_dialog_h_position" />
							<option value="left"><? echo $la['SIDE_LEFT']; ?></option>
							<option value="center"><? echo $la['CENTER']; ?></option>
							<option value="right"><? echo $la['SIDE_RIGHT']; ?></option>
						</select>
				...
				<div class="row2">
					...
					<div class="width50">
						<select style="width: 100px;" id="dialog_theme_login_dialog_v_position" />
				...
				<div class="row2">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_login_dialog_bg_color'/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="block width50">
			<div class="container">
				<div class="row2">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_top_panel_color'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_top_panel_border_color'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_top_panel_selection_color'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_dialog_titlebar_color'/>
					</div>
				</div>
			</div>
		</div>
		<div class="block width50">
			<div class="container last">
				<div class="row2">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_accent_color_1'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_accent_color_2'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_accent_color_3'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_accent_color_4'/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="block width50">
			<div class="container">
				<div class="row2">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_font_color'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_top_panel_font_color'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_top_panel_counters_font_color'/>
					</div>
				</div>
			</div>
		</div>
		<div class="block width50">
			<div class="container last">
				<div class="row2">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_heading_font_color_1'/>
					</div>
				</div>
				<div class="row2">
					<div class="width50">
					...
					<div class="width50">
						<input class="color inputbox" style="width:100px" type='text' id='dialog_theme_ui_heading_font_color_2'/>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="width-1000">
				...
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width10">
							<select id="cpanel_manage_server_notify_obj_expire" style="width:100px;" onChange="serverCheck();">
								<option value="true"><? echo $la['YES']; ?></option>
								<option value="false"><? echo $la['NO']; ?></option>
							</select>
						</div>
					...
					<div class="row2">
						...
						<div class="width10">
							<select id="cpanel_manage_server_notify_account_expire" style="width:100px;" onChange="serverCheck();">
								<option value="true"><? echo $la['YES']; ?></option>
								<option value="false"><? echo $la['NO']; ?></option>
							</select>
						</div>
			...
			<div class="width-1000">
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width50">
							<select style="width: 100px;" id="cpanel_manage_server_email_smtp" onChange="serverCheck();">
								<option value="true"><? echo $la['YES']; ?></option>
								<option value="false"><? echo $la['NO']; ?></option>
							</select>
						</div>
			...
			<div class="width-1000">
				...
				<div id="cpanel_manage_server_sms_app">
					<div class="row">
						...
						<div class="row"><? echo sprintf($la['SMS_GATEWAY_MOBILE_APPLICATION_EXPLANATION'], $gsValues['URL_SMS_GATEWAY_APP']); ?></div>
						<div class="row2">
			...
			<div class="width-1000">
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width12">
							<input class="button icon-create icon" type="button" onclick="serverCleanup('users');" value="<? echo $la['EXECUTE_NOW']; ?>" />
						</div>
					</div>
					<div class="row2">
						<div class="width40">
						...
						<div class="width12">
							<input class="button icon-create icon" type="button" onclick="serverCleanup('objects_not_activated');" value="<? echo $la['EXECUTE_NOW']; ?>" />
						</div>
					</div>
					<div class="row2">
						<div class="width40">
						...
						<div>
							<input class="button icon-create icon" type="button" onclick="serverCleanup('objects_not_used');" value="<? echo $la['EXECUTE_NOW']; ?>" />
						</div>
					</div>
					<div class="row2">
						<div class="width40">
						...
						<div class="width12">
							<input class="button icon-create icon" type="button" onclick="serverCleanup('db_junk');" value="<? echo $la['EXECUTE_NOW']; ?>" />
						</div>
					</div>
				</div>
			</div>
