        ...
        throws IOException
    {
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CSS_FORGOT_PASSWORD, m) {
            public void write(PrintWriter out) throws IOException {
                ...
                out.println("  <tr><td>"+i18n.getString("ForgotPassword.contactEMail","Contact Email:")+"</td><td><input class='"+CommonServlet.CSS_TEXT_INPUT+"' type='text' name='"+PARM_EMAIL_ADDRESS+"' value='' size='24' maxlength='32'></td></tr>");
                out.println("</table>");
                out.println("<input type='submit' name='"+PARM_EMAIL_SUBMIT+"' value='"+i18n.getString("ForgotPassword.submit","Submit")+"' class='button'>");
                out.println("</form>");
                out.println("<hr>");
                if (SEND_ACCOUNT_LIST) {
