    ...
    **/
    ...
    public static String Form_ComboBox(String id, String key, boolean editable, ComboMap map, ComboOption selKey, String onchange, int size)
    {
        ...
        if (editable || COMBOBOX_SHOW_DISABLED_IF_NOT_ENABLED) {
            ...
            sb.append(" name='" + key + "'");
            if (size > 0) {
                sb.append(" style='width:"+(size*6+20)+"px;'"); //Hienntd edit
            }
            if (editable) {
    ...
    public static String FormRow_ComboBox(String id, String key, boolean editable, String desc, ComboOption sel, ComboMap map, String onchange, int size, String trailingHtml)
    {
        ...
        if (editable || COMBOBOX_SHOW_DISABLED_IF_NOT_ENABLED) {
            ...
            //sb.append("<a  aria-owns=\"speedC-menu\" aria-haspopup=\"true\" href=\"#\" role=\"button\"  class=\"ui-selectmenu ui-widget ui-state-default ui-selectmenu-dropdown ui-corner-all\" style=\"width: 258px;\"><span class=\"ui-selectmenu-status\">"+sel.getDescription()+"</span><span class=\"ui-selectmenu-icon ui-icon ui-icon-triangle-1-s\"></span></a>");
    ...
    public static String Form_CheckBox(String id, String name, boolean editable, boolean checked, String tooltip, String onchange)
    {
        StringBuffer sb = new StringBuffer();
        /* form input */
        sb.append("<input type='checkbox' style='margin: 0px 0px 0px 2px;'");
        if (!StringTools.isBlank(id)) {
            sb.append(" id='" + id + "'");
        }
    ...
    /* Diepnb add this function to display NCD Decimal Begin*/
    public static String FilterText(String s)
    {
        // Don't use StringTools.isBlank(...) - spaces are significant
        return StringTools.replace(((s==null)||s.equals(""))? StringTools.HTML_SP : StringTools.htmlFilterText(s), "&amp;", "&");
    }
    /* Diepnb add this function to display NCD Decimal End*/
