    ...
    implements UserInformation
{
    ...
    **/
    ...
    public static final String FLD_Tax              		= "tax";
  ...
  //public static final String FLD_newUserRoleID            = "newUserRoleID";
    ...
    {
        String v = (String)this.getFieldValue(FLD_Tax);
        return StringTools.trim(v);
    }
    ...
    **/
    ...
    /*hienntd begin */
    public static Account createNewAccount(Account acctMgr, String acctID, String passwd,int speedunit, int distanceunit,String timezone)
            throws DBException
        {
            ...
            /* create account */
            Account acct = Account.getAccount(acctID, true); // not yet saved
            acct.setSpeedUnits(speedunit);
            acct.setDistanceUnits(distanceunit);
            acct.setTimeZone(timezone);
            /* set password */
            if (passwd != null) { // empty string allowed
                acct.setDecodedPassword(passwd);
            }
                    ...
                    if (StringTools.isBlank(type)     || 
                        ...
                        if (account.hasAdminUser()) {
                            ...
                            try {
                                ...
                                pass = (adminUser != null)? adminUser.getDecodedPassword() : "??";
                            } catch (DBException dbe) {
                                pass = "???";
                            }
                            asb.append(", pass=" + pass);
                        } else {
                            asb.append(", pass=" + account.getDecodedPassword());
                        }
                        asb.append("]");
                        // invalid ID
