    ...
    implements Constants
{
    ...
    // parameters
    public  static final String PARM_NEW_ID                 = "g_newid";
   ...
   // public  static final String PARM_DEV_SELECT             = "d_dev_";
    public  static final String PARM_DEV_SELECT_            = "d_select";
    // device properties
    ...
    public GroupInfo1()
    {
        ...
        this.setPageName(PAGE_GROUP_INFO1);
   ...
   public String getMenuDescription(RequestProperties reqState, String parentMenuName)
    {
        ...
        I18N i18n = privLabel.getI18N(GroupInfo1.class);
    ...
    public String getMenuHelp(RequestProperties reqState, String parentMenuName)
    {
        ...
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(GroupInfo1.class);
        return super._getMenuHelp(reqState,i18n.getString("GroupInfo1.editMenuHelp","View and Edit {0} information", grpTitles));
    }
    ...
    public String getNavigationDescription(RequestProperties reqState)
    {
        ...
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(GroupInfo1.class);
        return super._getNavigationDescription(reqState,i18n.getString("GroupInfo1.navDesc","{0}", grpTitles));
    }
    ...
    public String getNavigationTab(RequestProperties reqState)
    {
        ...
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(GroupInfo1.class);
        return super._getNavigationTab(reqState,i18n.getString("GroupInfo1.navTab","{0} Admin", grpTitles));
    }
    ...
    private String _queueDeviceGroupProperties(DeviceGroup selGroup, User userAuth, HttpServletRequest request, I18N i18n)
    {
        ...
        if (!this._addPropertyPacket(request,PARM_PROP_START_TYPE,PropertyKey.PROP_MOTION_START_TYPE,propList)) {
            msg = i18n.getString("GroupInfo1.invalidStartType","Invalid 'Start Type' property");
            return msg;
        }
        ...
        if (!this._addPropertyPacket(request,PARM_PROP_START_DEF,PropertyKey.PROP_MOTION_START,propList)) {
            msg = i18n.getString("GroupInfo1.invalidStartDefinition","Invalid 'Start Definition' property");
            return msg;
        }
        ...
        if (!this._addPropertyPacket(request,PARM_PROP_MOT_INTERV,PropertyKey.PROP_MOTION_IN_MOTION,propList)) {
            msg = i18n.getString("GroupInfo1.invalidInMotion","Invalid 'In-Motion Interval' property");
            return msg;
        }
        ...
        if (!this._addPropertyPacket(request,PARM_PROP_STOP_TYPE,PropertyKey.PROP_MOTION_STOP_TYPE,propList)) {
            msg = i18n.getString("GroupInfo1.invalidStopType","Invalid 'Stop Type' property");
            return msg;
        }
        ...
        if (!this._addPropertyPacket(request,PARM_PROP_STOP_INTERV,PropertyKey.PROP_MOTION_STOP,propList)) {
            msg = i18n.getString("GroupInfo1.invalidStopInterval","Invalid 'Stop Interval' property");
            return msg;
        }
        ...
        if (!this._addPropertyPacket(request,PARM_PROP_DORM_INTERV,PropertyKey.PROP_MOTION_DORMANT_INTRVL,propList)) {
            msg = i18n.getString("GroupInfo1.invalidDormantInterval","Invalid 'Dormant Interval' property");
            return msg;
        }
        ...
        if (!this._addPropertyPacket(request,PARM_PROP_DORM_COUNT,PropertyKey.PROP_MOTION_DORMANT_COUNT,propList)) {
            msg = i18n.getString("GroupInfo1.invalidDormantCount","Invalid 'Dormant Count' property");
            return msg;
        }
        ...
        if (!this._addPropertyPacket(request,PARM_PROP_EXCESS_SPEED,PropertyKey.PROP_MOTION_EXCESS_SPEED,propList)) {
            msg = i18n.getString("GroupInfo1.invalidExcessSpeed","Invalid 'Excess Speed' property");
            return msg;
        }
        
        /* no properties defined? */
        if (propList.isEmpty()) {
            msg = i18n.getString("GroupInfo1.noPropertiesChanged","No property changes have been defined");
            return msg;
        }
        ...
        try {
            ...
            if (ListTools.isEmpty(devList)) {
                return i18n.getString("GroupInfo1.noDevicesInGroup","No authorized devices in this group");
            }
        } catch (DBException dbe) {
            Print.logException("Reading Devices", dbe);
            return i18n.getString("GroupInfo1.errorReadingDevices","Internal Devices error");
        }
        ...
        for (int d = 0; d < devList.size(); d++) {
            try {
                ...
                msg = i18n.getString("GroupInfo1.errorPendingPacket","Internal PendingPacket error");
                break;
        ...
        if (queueCount == 0) {
            return i18n.getString("GroupInfo1.noPropertiesQueued","No property changes have been queued");
        } else {
            return i18n.getString("GroupInfo1.setPropertiesQueued","Requested property changes have been queued");
        }
        ...
        throws IOException
    {
        ...
        final I18N         i18n        = privLabel.getI18N(GroupInfo1.class);
        ...
        if (newGroup) {
            if (!allowNew) {
                ...
                newGroupID = AttributeTools.getRequestString(httpReq,PARM_NEW_ID,"").trim();
                newGroupID = newGroupID.toLowerCase();
                newGroupName=AttributeTools.getRequestString(httpReq, PARM_NEW_NAME, "");
                if (StringTools.isBlank(newGroupID)) {
                    m = i18n.getString("GroupInfo1.enterNewGroup","Please enter a new {0} ID.", grpTitles);
                    error = true;
                    newGroup = false;
                } else
                if (!WebPageAdaptor.isValidID(reqState,/*PrivateLabel.PROP_GroupInfo_validateNewIDs,*/newGroupID)) {
                    m = i18n.getString("GroupInfo1.invalidIDChar","ID contains invalid characters");
                    error = true;
                    newGroup = false;
                }
            }
        ...
        if (updateGroup) {
            ...
            if (!SubmitMatch(submitChange,i18n.getString("GroupInfo1.change","Change"))) {
                updateGroup = false;
            } else
            if (selGroup == null) {
                // should not occur
                m = i18n.getString("GroupInfo1.unableToUpdate","Unable to update Group, ID not found");
                error = true;
                updateGroup = false;
            }
        } else
        if (updateProps) {
            ...
            if (selGroup == null) {
                m = i18n.getString("GroupInfo1.pleaseSelectGroup","Please select a {0}", grpTitles);
                error = true;
                updateProps = false; // not selected
            } else
            if (!SubmitMatch(submitQueue,i18n.getString("GroupInfo1.queue","Queue"))) {
                updateProps = false;
            }
        } else
        if (selectGroup) {
            if (SubmitMatch(submitDelete,i18n.getString("GroupInfo1.delete","Delete"))) {
                if (!allowDelete) {
            ...
            if (SubmitMatch(submitEdit,i18n.getString("GroupInfo1.edit","Edit"))) {
                if (!allowEdit) {
            ...
            if (SubmitMatch(submitView,i18n.getString("GroupInfo1.view","View"))) {
                if (!allowView) {
            ...
            if (SubmitMatch(submitProps,i18n.getString("GroupInfo1.properties","Properties"))) {
                if (!allowProp) {
        ...
        if (deleteGroup) {
            ...
            try {
                ...
                m = i18n.getString("GroupInfo1.errorDelete","Internal error deleting {0}", grpTitles);
                error = true;
            }
            uiList = true;
        }
        ...
        if (newGroup) {
            ...
            for (int u = 0; u < groupList.size(); u++) {
                if (newGroupID.equalsIgnoreCase(groupList.get(u))) {
                    m = i18n.getString("GroupInfo1.alreadyExists","This {0} ID already exists", grpTitles);
                    error = true;
                    createGroupOK = false;
                    break;
                }
            ...
            if (createGroupOK) {
                try {
                    DeviceGroup group = DeviceGroup.createNewDeviceGroup(currAcct, newGroupID,newGroupName);
                    reqState.clearDeviceGroupList();
                    groupList = reqState.getDeviceGroupIDList(true);
                    selGroup = group;
                    selGroupID = group.getGroupID();
                    
                    String  devKeys[] = AttributeTools.getMatchingKeys( request, PARM_DEV_SELECT_);
                    
                    if (!selGroup.hasError()) {
                        String accountID = selGroup.getAccountID();
                        String groupID  = selGroup.getGroupID();
                        // 'grpKey' may only contain 'checked' items!
                        OrderedSet<String> fullGroupSet = reqState.getDeviceGroupIDList(true);
                        // add checked groups
                        if (!ListTools.isEmpty(devKeys)) {
                            for (int i = 0; i < devKeys.length; i++) {
                                String devID = devKeys[i].substring(PARM_DEV_SELECT_.length());
                                if (!devID.equalsIgnoreCase(DeviceGroup.DEVICE_GROUP_ALL)) {
                                    String chkStr = AttributeTools.getRequestString(request,devKeys[i],"");
                                    boolean chked = chkStr.equalsIgnoreCase("on");
                                    boolean exists = DeviceGroup.isDeviceInDeviceGroup(accountID, groupID, devID);
                                    //Print.logInfo("Checking group : " + grpID + " [checked=" + chked + "]");
                                    if (chked) {
                                        if (!exists) {
                                            DeviceGroup.addDeviceToDeviceGroup(accountID, groupID, devID);  
                                        }
                                    } else {
                                        if (exists) {
                                            DeviceGroup.removeDeviceFromDeviceGroup(accountID, groupID, devID);  
                                        }
                                    }
                                    fullGroupSet.remove(groupID);
                                }
                            }
                        }
                    ...
                    m = i18n.getString("GroupInfo1.createdGroup","New {0} has been created", grpTitles);
                    
                } catch (DBException dbe) {
                    Print.logException("Creating DeviceGroup", dbe);
                    m = i18n.getString("GroupInfo1.errorCreate","Internal error creating {0}", grpTitles);
                    error = true;
                }
            }
            uiList = true;
        ...
        if (updateGroup) {
            ...
            try {
                ...
                if (saveOK) {
                    ...
                    selGroup.save();
                    m = i18n.getString("GroupInfo1.groupUpdated","{0} information updated", grpTitles);
                } else {
                    // should stay on this page
                }
            } catch (Throwable t) {
                Print.logException("Updating DeviceGroup", t);
                m = i18n.getString("GroupInfo1.errorUpdating","Internal error updating {0}", grpTitles);
                error = true;
            }
            uiList = true;
        }
        ...
        HTMLOutput HTML_CSS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                String cssDir = GroupInfo1.this.getCssDirectory();
                WebPageAdaptor.writeCssLink(out, reqState, "GroupInfo1.css", cssDir);
            }
        };
        ...
        if (_uiList) {
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                    String pageName = GroupInfo1.this.getPageName();
                    //String grpTitles[] = reqState.getDeviceGroupTitles();
                    String devTitles[] = reqState.getDeviceTitles();
                   // DBGroup dbgroup = new DBGroup(); 
                    DBCamera dbcmr = new DBCamera(); 
                	
                  //  ArrayList<String> arr= dbgroup.getAllDevice(currAcct.getAccountID());
                    // frame header
                  //String menuURL    = EncodeMakeURL(reqState,RequestProperties.TRACK_BASE_URI(),PAGE_MENU_TOP);
                    ...
                    String editURL    = GroupInfo1.this.encodePageURL(reqState);//,RequestProperties.TRACK_BASE_URI());
                    String selectURL  = GroupInfo1.this.encodePageURL(reqState);//,RequestProperties.TRACK_BASE_URI());
                    String newURL     = GroupInfo1.this.encodePageURL(reqState);//,RequestProperties.TRACK_BASE_URI());
                    String frameTitle = _allowEdit? 
                        i18n.getString("GroupInfo1.viewEditGroup","View/Edit {0} Information", grpTitles) : 
                        i18n.getString("GroupInfo1.viewGroup","View {0} Information", grpTitles);
                    ...
                    out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL_SEL+"' nowrap>"+i18n.getString("GroupInfo1.select","Select")+"</th>\n");
                    out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+i18n.getString("GroupInfo1.groupID","{0} ID",grpTitles)+"</th>\n");
                    out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+i18n.getString("GroupInfo1.groupName","{0} Name",grpTitles)+"</th>\n");
                  //  out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+i18n.getString("GroupInfo.Checkbox","{0}","")+"</th>\n");
                    out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+i18n.getString("GroupInfo1.deviceCount","{0} Count",devTitles)+"</th>\n");
                    out.write("  </tr>\n");
                    out.write(" </thead>\n");
                    out.write(" <tbody>\n");
                    ...
                    if (_allowView  ) { 
                        ...
                        out.write("<input type='submit' name='"+PARM_SUBMIT_VIEW+"' value='"+i18n.getString("GroupInfo1.view","View")+"'  class='button'>");
                        out.write("</td>\n"); 
                    }
                    if (_allowEdit  ) { 
                        out.write("<td style='padding-left:5px;'>");
                        out.write("<input type='submit' name='"+PARM_SUBMIT_EDIT+"' value='"+i18n.getString("GroupInfo1.edit","Edit")+"'  class='button'>");
                        out.write("</td>\n"); 
                    }
                    if (_allowProp  ) { 
                        out.write("<td style='padding-left:5px;'>");
                        out.write("<input type='submit' name='"+PARM_SUBMIT_PROP+"' value='"+i18n.getString("GroupInfo1.properties","Properties")+"'  class='button'>");
                        out.write("</td>\n"); 
                    }
                    out.write("<td style='width:100%; text-align:right; padding-right:10px;'>");
                    if (_allowDelete) { 
                        out.write("<input type='submit' name='"+PARM_SUBMIT_DEL+"' value='"+i18n.getString("GroupInfo1.delete","Delete")+"' "+Onclick_ConfirmDelete(locale)+"  class='button'>");
                    } else {
                        out.write("&nbsp;"); 
                    }
                    out.write("</td>\n");
                    ...
                    /* new group */
                    if (_allowNew) {
                    out.write("<h1 class='"+CommonServlet.CSS_ADMIN_SELECT_TITLE+"'>"+i18n.getString("GroupInfo1.createNewGroup","Create a new {0}",grpTitles)+":</h1>\n");
                    ...
                    //out.println(FormRow_TextField(PARM_GROUP_SELECT, true     , i18n.getString("GroupInfo.groupID","{0} ID",grpTitles)+":" , "", 20, 32));
                    //out.println(FormRow_TextField(PARM_GROUP_DESC  , true, i18n.getString("GroupInfo.groupName","{0} Name",grpTitles)+":", "", 60, 64));
                   // out.println("</table>");
                    
                   
                    out.println("<table class='"+CommonServlet.CSS_ADMIN_VIEW_TABLE+"' cellspacing='0' callpadding='0' border='0'>");
                    out.println("<tr><td width='100px'>");
                    out.print(i18n.getString("GroupInfo1.groupID","{0} ID",grpTitles)+":</td><td>");
                    out.write("<input type='text' class='"+CommonServlet.CSS_TEXT_INPUT+"' name='"+PARM_NEW_ID+"' value='' size='50' maxlength='32'></td></tr><tr><td>\n");
                    out.print(i18n.getString("GroupInfo1.groupName","{0} Name",grpTitles)+":</td><td>");
                    out.write( "<input type='text' class='"+CommonServlet.CSS_TEXT_INPUT+"' name='"+PARM_NEW_NAME+"' value='' size='50' maxlength='40'></td></tr>\n");
                    out.print("</table><br/>");
                    /* Devices in group (read only) */
                    out.write("<span style='margin-left: 4px; margin-top: 8px; font-weight: bold;'>");
                    out.write(i18n.getString("GroupInfo1.currentDeviceList","Current {0} Member List",devTitles) + ":");
                    out.write("</span>\n");

                    //out.write("<table cellspacing='0' cellpadding='0' border='0'><tbody><tr>\n");
                    //out.write("<td>\n");
                    out.write("<div class='"+CSS_DEVICES_VIEW+"' style='width:500px'>\n");
                    try {
                       // OrderedSet<String> devList = DeviceGroup.getDeviceIDsForGroup(currAcct.getAccountID(), _selGroupID, null/*User*/, true/*inclInactv*/);
                        ArrayList<String> devList= dbcmr.getAllDevice(currAcct.getAccountID());//DeviceGroup.getDeviceGroupsForAccount(currAcct.getAccountID(),true);
                        ...
                        String sortByStr = privLabel.getStringProperty(PrivateLabel.PROP_GroupInfo_deviceLisSortBy,"desc");
                    ...
                    out.write("<th class='"+CSS_DEVICES_HEADER_COL+"' nowrap width='200' valign='center'>"+i18n.getString("GroupInfo1.deviceName","Name")+"</th>\n");
                    out.write("<th class='"+CSS_DEVICES_HEADER_COL+"' nowrap width='100' valign='center'>"+i18n.getString("GroupInfo1.deviceID"  ,"ID"  )+"</th>\n");
                    out.write("<th class='"+CSS_DEVICES_HEADER_COL+"' nowrap width='100' valign='center'>"+i18n.getString("GroupInfo1.Select"  ,"Select"  )+"</th>\n");
                    } else {
                    out.write("<th class='"+CSS_DEVICES_HEADER_COL+"' nowrap width='100' valign='center'>"+i18n.getString("GroupInfo1.deviceID"  ,"ID"  )+"</th>\n");
                    out.write("<th class='"+CSS_DEVICES_HEADER_COL+"' nowrap width='200' valign='center'>"+i18n.getString("GroupInfo1.deviceName","Name")+"</th>\n");
                    out.write("<th class='"+CSS_DEVICES_HEADER_COL+"' nowrap width='100' valign='center'>"+i18n.getString("GroupInfo1.Select"  ,"Select"  )+"</th>\n");
                    ...
                    for (int d = 0; d < listCnt; d++) {
                        ...
                        out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='100'>"+ Form_CheckBox(null,name,true,false,null,null) + "</td>\n");
                        } else {
                        out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='100'>"+ devID + "</td>\n");
                        out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='200'>"+ desc  + "</td>\n");
                        out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='100'>"+ Form_CheckBox(null,name,true,false,null,null) + "</td>\n");
                    ...
                    out.write("</div><br/>");
                    out.write(" <input type='submit' name='"+PARM_SUBMIT_NEW+"' value='"+i18n.getString("GroupInfo1.new","New")+"' style='margin-top:5px; margin-left:10px;'  class='button'>\n");
                    out.write("</form>\n");
                    out.write("</div>\n");
                    out.write("<hr>\n");
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,RequestProperties.TRACK_BASE_URI(),PAGE_MENU_TOP);
                    ...
                    // group selection table (Select, Group ID, Group Description)
                    out.write("<h1 class='"+CommonServlet.CSS_ADMIN_SELECT_TITLE+"'>"+i18n.getString("GroupInfo1.selectGroup","Select a {0}",grpTitles)+":</h1>\n");
                    out.write("<div style='margin-left:25px;'>\n");
                    out.write("<form name='"+FORM_GROUP_SELECT+"' method='post' action='"+selectURL+"' target='_self'>"); // target='_top'
                    out.write("<input type='hidden' name='"+PARM_COMMAND+"' value='"+COMMAND_INFO_SELECT+"'/>");
                    out.write("<table class='"+CommonServlet.CSS_ADMIN_SELECT_TABLE+"' cellspacing=0 cellpadding=0 border=0>\n");
                  ...
                  //  out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+i18n.getString("GroupInfo.Checkbox","{0}","")+"</th>\n");
                    ...
                    try {
                    	if(_editGroup)
                    	{
                            ...
                            out.println("<table class='"+CommonServlet.CSS_ADMIN_VIEW_TABLE+"' cellspacing='0' callpadding='0' border='0'>");
                            out.println(FormRow_TextField(PARM_GROUP_SELECT, false     , i18n.getString("GroupInfo1.groupID","{0} ID",grpTitles)+":" , _selGroupID, 50, 32));
                            out.println(FormRow_TextField(PARM_GROUP_DESC  , _editGroup, i18n.getString("GroupInfo1.groupName","{0} Name",grpTitles)+":", (_selGroup!=null)?_selGroup.getDescription() :"", 50, 40));
                            ...
                            ArrayList<String> devListAll= dbcmr.getAllDevice(currAcct.getAccountID());
                    		//OrderedSet<String> devList = DeviceGroup.getDeviceIDsForGroup(currAcct.getAccountID(), _selGroupID, null/*User*/, true/*inclInactv*/);
                            java.util.List<IDDescription> list = new Vector<IDDescription>();
                           
                            for (int i = 0; i < devListAll.size(); i++) {
                                String desc = reqState.getDeviceDescription(devListAll.get(i),false/*!rtnDispName*/);
                                list.add(new IDDescription(devListAll.get(i),desc));
                            }
                            String sortByStr = privLabel.getStringProperty(PrivateLabel.PROP_GroupInfo_deviceLisSortBy,"desc");
                            IDDescription.SortBy sortBy = IDDescription.GetSortBy(sortByStr);
                            ListTools.sort(list, null); // uses StringComparator
                            ...
                            for (int d = 0; d < listCnt; d++) {
                                ...
                                out.write("<tr class='"+rowClass+"'>\n");
                                out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='25' >"+ (d+1) + "</td>\n");
                                Boolean equalstr = false;
                                
                                boolean exists = DeviceGroup.isDeviceInDeviceGroup(currAcct.getAccountID(), _selGroupID, devID);
                                if (sortBy.equals(IDDescription.SortBy.DESCRIPTION)) {
                                out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='200'>"+ desc  + "</td>\n");
                                out.write("<td class  ='"+CSS_DEVICES_DATA_COL+"' nowrap width='100'>"+ devID + "</td>\n");
                                out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='100'>"+Form_CheckBox(null,name,true,exists,null,null)+"</td>\n");
                                } else {
                                out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='100'>"+ devID + "</td>\n");
                                out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='200'>"+ desc  + "</td>\n");
                                out.write("<td class='"+CSS_DEVICES_DATA_COL+"' nowrap width='100'>"+Form_CheckBox(null,name,true,exists,null,null)+"</td>\n");
                            ...
                            out.write("</table>");
                            out.write("</div><br/>");
                            out.write("<input type='submit' name='"+PARM_SUBMIT_CHG+"' value='"+i18n.getString("GroupInfo1.change","Change")+"'  class='button'  style='margin-left:10px'>\n");
                            
                            out.write("<span style='padding-left:10px'>&nbsp;</span>\n");
                            out.write("<input type='button' name='"+PARM_BUTTON_CANCEL+"' value='"+i18n.getString("GroupInfo1.cancel","Cancel")+"' onclick=\"javascript:openURL('"+editURL+"','_self');\" class='button'>\n"); // target='_top'
                            out.write("</form>\n");
                    	}
                    	else
                    	{
                    		out.write("<form name='"+FORM_GROUP_SELECT+"' method='post' action='"+selectURL+"' target='_self'>\n"); // target='_top'
                            out.write("<input type='hidden' name='"+PARM_COMMAND+"' value='"+COMMAND_INFO_UPD_GROUP+"'/>\n");
                            ...
                            out.write("</table><br/>");
                            out.write("</div>\n");
                            out.write("<input type='button' name='"+PARM_BUTTON_BACK+"' value='"+i18n.getString("GroupInfo1.back","Back")+"' onclick=\"javascript:openURL('"+selectURL+"','_self');\" class='button' style='margin-left:10px'>\n"); // target='_top'
                            //out.write("</td>\n");
                            //out.write("<td width='100%'>&nbsp;</td></tr></tbody></table>\n");
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,RequestProperties.TRACK_BASE_URI(),PAGE_MENU_TOP);
                    ...
                    String editURL    = GroupInfo1.this.encodePageURL(reqState);//,RequestProperties.TRACK_BASE_URI());
                    String selectURL  = GroupInfo1.this.encodePageURL(reqState);//,RequestProperties.TRACK_BASE_URI());
                    String frameTitle = i18n.getString("GroupInfo1.setDeviceProperties","Set {0} Properties",grpTitles);
                    out.write("<span class='"+CommonServlet.CSS_MENU_TITLE+"'>"+frameTitle+"</span><br/>\n");
                    out.write("<hr>\n");
                    ...
                    /* Device fields */
                    out.println("  <table>");
                    out.println(FormRow_TextField(PARM_GROUP_SELECT     , false     , i18n.getString("GroupInfo1.groupID","{0} ID",grpTitles)+":"         , _selGroupID, 30, 30));
                    out.println(FormRow_TextField(PARM_GROUP_DESC       , false     , i18n.getString("GroupInfo1.description","{0} Name",grpTitles) +":"  , (_selGroup!=null)?_selGroup.getDescription():"", 40, 40));
                    out.println(FormRow_TextField(PARM_PROP_START_TYPE  , _editProps, i18n.getString("GroupInfo1.startType","Start Type")+":"             , "", 2, 2));
                    out.println(FormRow_TextField(PARM_PROP_START_DEF   , _editProps, i18n.getString("GroupInfo1.startDefinition","Start Definition")+":" , "", 5, 5));
                    out.println(FormRow_TextField(PARM_PROP_MOT_INTERV  , _editProps, i18n.getString("GroupInfo1.motionInterval","In-Motion Interval")+":", "", 5, 5));
                    out.println(FormRow_TextField(PARM_PROP_STOP_TYPE   , _editProps, i18n.getString("GroupInfo1.stopType","Stop Type")+":"               , "", 2, 2));
                    out.println(FormRow_TextField(PARM_PROP_STOP_INTERV , _editProps, i18n.getString("GroupInfo1.stopInterval","Stop Interval")+":"       , "", 5, 5));
                    out.println(FormRow_TextField(PARM_PROP_DORM_INTERV , _editProps, i18n.getString("GroupInfo1.dormantInterval","Dormant Interval")+":" , "", 5, 5));
                    out.println(FormRow_TextField(PARM_PROP_DORM_COUNT  , _editProps, i18n.getString("GroupInfo1.dormantCount","Dormant Count")+":"       , "", 5, 5));
                    out.println(FormRow_TextField(PARM_PROP_EXCESS_SPEED, _editProps, i18n.getString("GroupInfo1.excessSpeed","Excess Speed")+":"         , "", 5, 5));
                    out.println("  </table>");

                    /* end of form */
                    out.write("<hr>\n");
                    if (_editProps) {
                    out.write("<input type='submit' name='"+PARM_SUBMIT_QUE+"' value='"+i18n.getString("GroupInfo1.queue","Queue")+"'  class='button'>\n");
                    }
                    out.write("<a href='"+editURL+"' style='margin-left:20px;'>"+(_editProps?i18n.getString("GroupInfo1.cancel","Cancel"):i18n.getString("GroupInfo1.back","Back"))+"</a>\n");
                    out.write("</form>\n");
