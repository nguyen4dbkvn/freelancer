        ...
        throws IOException
    {
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
            public void write(PrintWriter out) throws IOException {
                ...
                out.write("<tr>\n");
                out.write("<td valign='top' height='100%' style='padding-right:3px; border-right: 3px double white;'>\n");
                    ...
                    if (DeviceChooser.isDeviceChooserUseTable(privLabel)) { // Fleet
                        ...
                        switch (sortBy) {
                            case DESCRIPTION : {
                                ...
                                out.write("<input id='"+ID_DEVICE_DESCR+"' name='"+ID_DEVICE_DESCR+"' type='text' value='"+grDesc+"' readonly size='"+chooserLen+"' class='textDrop' onclick=\""+chooserOnclick+"\">");
                                } break;
                            case NAME : {
                                String grName = FilterValue(reqState.getDeviceGroupDescription(_groupID,true));
                                out.write("<input id='"+ID_DEVICE_ID   +"' name='"+PARM_GROUP_ID  +"' type='hidden' value='"+_groupID+"'>");
                                out.write("<input id='"+ID_DEVICE_DESCR+"' name='"+ID_DEVICE_DESCR+"' type='text' value='"+grName+"' readonly size='"+chooserLen+"' class='textDrop' onclick=\""+chooserOnclick+"\">");
                                } break;
                            default : {
                                out.write("<input id='"+ID_DEVICE_ID   +"' name='"+PARM_GROUP_ID  +"' type='text' value='"+_groupID+"' readonly size='"+chooserLen+"' class='textDrop' onclick=\""+chooserOnclick+"\">");
                                } break;
                        }
                        out.write("</td>");
                    ...
                    if (DeviceChooser.isDeviceChooserUseTable(privLabel)) { // Device
                        ...
                        switch (sortBy) {
                            case DESCRIPTION : {
                                ...
                                out.write("<input id='"+ID_DEVICE_DESCR+"' name='"+ID_DEVICE_DESCR+"' type='text' value='"+dvDesc   +"' readonly size='"+chooserLen+"' class='textDrop' onclick=\""+chooserOnclick+"\">");
                                } break;
                            case NAME : {
                                String dvName = FilterValue(reqState.getDeviceDescription(_deviceID,true));
                                out.write("<input id='"+ID_DEVICE_ID   +"' name='"+PARM_DEVICE_ID +"' type='hidden' value='"+_deviceID+"'>");
                                out.write("<input id='"+ID_DEVICE_DESCR+"' name='"+ID_DEVICE_DESCR+"' type='text' value='"+dvName   +"' readonly size='"+chooserLen+"' class='textDrop' onclick=\""+chooserOnclick+"\">");
                                } break;
                            default : {
                                out.write("<input id='"+ID_DEVICE_ID   +"' name='"+PARM_DEVICE_ID +"' type='text' value='"+_deviceID+"' readonly size='"+chooserLen+"' class='textDrop' onclick=\""+chooserOnclick+"\">");
                                } break;
                        }
                        out.write("</td>");
                       // out.write("<td><img src='images/Pulldown.png' height='17' style='cursor:pointer;' onclick='"+chooserOnclick+"'></td>");
                ...
                if (showTimezoneSelect) {
                    ...
                    out.println(  "<select name='"+parm_TIMEZONE[0]+"' class='adminComboBox ' onchange=\"javascript:calSelectTimeZone(document.TimeZoneSelect."+parm_TIMEZONE[0]+".value)\">");
                ...
                out.write("    <select id='"+PARM_FORMAT[0]+"' name='"+PARM_FORMAT[0]+"' class='adminComboBox' onchange=\"javascript:rptmFormatChanged();\">\n");
              ...
              //out.write("      <option value='"+ReportURL.FORMAT_TXT  +"'>TXT</option>\n");
                ...
                out.write("    </select>\n");
                out.write("    <span style='margin-left:40px;'><input type='submit' class='button' name='"+PARM_REPORT_SUBMIT+"' value='"+i18n.getString("ReportMenu.getReport","Get Report")+"'></span>\n");
                out.write("    <br>\n");
                out.write("    <br>\n");
