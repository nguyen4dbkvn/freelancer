...
// WebPage interface
    ...
    public String getMenuDescription(RequestProperties reqState, String parentMenuName)
    {
        ...
        I18N         i18n        = privLabel.getI18N(BaoCaoTocDoCuaXe.class);
        String       devTitles[] = reqState.getDeviceTitles();
        return super._getMenuDescription(reqState,"Tốc độ của xe");
    }
    ...
    public String getMenuHelp(RequestProperties reqState, String parentMenuName)
    {
        ...
        I18N         i18n        = privLabel.getI18N(BaoCaoTocDoCuaXe.class);
        String       devTitles[] = reqState.getDeviceTitles();
        return super._getMenuHelp(reqState,"Tốc độ của xe");
    }
    ...
    public String getNavigationDescription(RequestProperties reqState)
    {
        ...
        I18N         i18n        = privLabel.getI18N(BaoCaoTocDoCuaXe.class);
        String       devTitles[] = reqState.getDeviceTitles();
        return super._getNavigationDescription(reqState,"Tốc độ của xe");
    }
    ...
    public String getNavigationTab(RequestProperties reqState)
    {
        ...
        I18N         i18n        = privLabel.getI18N(BaoCaoTocDoCuaXe.class);
        String       devTitles[] = reqState.getDeviceTitles();
        return super._getNavigationTab(reqState,"Tốc độ của xe");
    }
    ...
    public String report(String tungay,String denngay,String devid,String timezone,String accid,PrivateLabel privLabel) throws IOException
    {
    	...
    	try
    	{
    		...
    		objcmr.Speed30s(accid, devid, tungay, denngay, timezone);

    		EventData ed[]= objcmr.GetReportDetail(tungay, denngay, devid, timezone, accid, new int[]{61714, 61472});
    		record=ed.length;
    		strscr =strscr+ "<table  id='myTable' width='100%' class='adminSelectTable_sortable' cellspacing='1' ><thead><tr  align='center'><th  class='adminTableHeaderCol_sort'>TT</th>" +
    				"<th  class='adminTableHeaderCol_sort'>Thời điểm <br/>(giờ, phút, giây, ngày, tháng, năm)</th><th class='adminTableHeaderCol_sort'>Các tốc độ (km/h)</th><th  class='adminTableHeaderCol_sort'>Ghi chú</th>";
...
//    			strscr =strscr+"<tr class ="+css+"><td>"+(j+1)+"</td><td>"+day+"</td><td>"+ round(ed[j].getSpeedKPH(),2)+"</td><td>"+ed[j].getNotes()+"</td>";//vietadd
    			strscr = strscr + "<tr class ="+css+"><td>"+(j+1)+"</td><td>"+day+"</td><td>" 
    					+ ed[j].getSpeed30s().replace("-", ", ") +"</td><td>"+ed[j].getNotes()+"</td>"; 					
    			
    			strscr=strscr+"</tr>";
    		}
    		if(ed.length==0){
    			strscr +="<tr class='adminTableBodyRowEven'><td colspan='4'> Không có dữ liệu.</td></tr>";
    		}
    		strscr =strscr+"</table>";
    	}
        ...
        throws IOException
    {
        	...
        	{  
		        ...
		        cst.setFont(ft);
		     	HSSFCell ct = title.createCell((short) 0);
       			...
       			ct.setCellStyle(cst);
       			ct.setCellValue("BÁO CÁO TỐC ĐỘ CỦA XE");
		       	...
		       	try{
         			...
         			for(int j =0;j<ed.length;j++)
         			{
            			...
            			HSSFCell r0=row.createCell((short) 0);
          				...
          				r2.setCellStyle(csr);
          				r2.setCellValue(ed[j].getSpeed30s().replace("-", ", "));           
          				
          				 
          				HSSFCell r3=row.createCell((short) 3);
          				r3.setCellStyle(csr);
          				r3.setCellValue(ed[j].getNotes());
        ...
        HTMLOutput HTML_CSS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                String cssDir = BaoCaoTocDoCuaXe.this.getCssDirectory();
            ...
            public void write(PrintWriter out) throws IOException {
             ...
             // view submit
              ...
              //  String sql = LoadReport(tuNgay,denNgay,contentall,currAcct.getAccountID(), pindex, pagesize,privLabel);
                ...
                out.println("<span class='"+CommonServlet.CSS_MENU_TITLE+"'>Tốc độ của xe</span><br/>");
                out.println("<hr/>");
