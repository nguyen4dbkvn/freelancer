...
public abstract class TrackMapFleetAbstract
    ...
    implements Constants
{
    ...
    private static final String  ID_DEV_SEARCH                  = "Dev";
  ...
  //MinhNV viet o day
    ...
    public String chonTram(String Acc)
    {
    	String strre = "<table style='width:100%; background-color: transparent;'>";
    	try 
    	{
    		...
    		{
    			strre +="<tr><td  align=\"left\" style=\"color:white;font-size:9px\"><a href='javascript:MinhSetCenter("+rs[2]+","+rs[3]+",15,\""+rs[1]+"\")'>"+rs[1]+
    					"</a><br/>........................................................</td></tr>";
        ...
        throws IOException
    {
        ...
        HTMLOutput HTML_CSS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                ...
                //MinhNV them bubble css
                out.print("<link href='./css/bubble.css' type='text/css' rel='Stylesheet' />");
                out.print("<link href='./css/demo.css' type='text/css' rel='Stylesheet' />");
                out.print("<link href='./css/basic.css' type='text/css' rel='Stylesheet' />");
                out.print("<link href='./css/basic_ie.css' type='text/css' rel='Stylesheet' />");
				out.print("<link href='./css/scrollbar.css' type='text/css' rel='Stylesheet' />");
                //out.print("<link href='./css/StyleSheet.css' type='text/css' rel='Stylesheet' />");
				 out.print("<link href='./css/MinhNVScrollBar.css' type='text/css' rel='Stylesheet' />");
        ...
        HTMLOutput HTML_JS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                String pageName = TrackMapFleetAbstract.this.getPageName();                
                out.print( "<script src='./js/jquery-1.4.2.min.js' type=\"text/javascript\"></script>"); 
                out.print( "<script src=\"./js/jquery.jqDock.js\"type=\"text/javascript\"></script>"+
                 "<script src=\"./js/jquery.jqDock.min.js\" type=\"text/javascript\"></script>");
                out.print( "<script src='./js/jquery.rotate.1-1.js' type=\"text/javascript\"></script>"); 
                out.print( "<script src='./js/basic.js' type=\"text/javascript\"></script>");
                out.print( "<script src='./js/jquery.simplemodal.js' type=\"text/javascript\"></script>");
                out.print( "<script src='./js/jquery.tinyscrollbar.min.js' type=\"text/javascript\"></script>");
                //out.print( "<script src='./js/jquery.tinyscrollbar.min.js' type=\"text/javascript\"></script>");
               // out.print("<script type='text/javascript'>$(document).ready(function() {$('#MinhNVScrollBar').tinyscrollbar();}); </script>");
                ...
                //Minhnv them jquery cho image bubble show
            //  out.print(  " <script type=\"text/javascript\" src=\"http://maps.google.com/maps/api/js?sensor=false\"></script>"+
               // " <script  src=\"http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAUWaVR4bMaA3NxLrVp6Q11xT61Bx9xizW4UfxyxbFuHHc3plSlRRRbf9sUiyL8sKS8LNNdDEL00qGyA\"  type=\"text/javascript\"></script>"); 
                
               
              
                
               out.print( "<script type='text/javascript'>" + 
                "jQuery(document).ready(function($){ var dockOptions ={ align: 'bottom', labels: true   };  $('#menu').jqDock(dockOptions);});</script>");
              
                TrackMapFleetAbstract.this.writeJS_MapUpdate(reqState, out, 
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput((mapAutoSize? CommonServlet.CSS_CONTENT_MAP_FULL : CommonServlet.CSS_CONTENT_MAP), m) {
            public void write(PrintWriter out) throws IOException {
                ...
                out.println("<tr>");
                 //hienntd edit
                out.println("<td colspan='"+colspan+"' id ='searchDev' style='height:20px; padding:0px 0px 5px 0px;float:left;width:275px;'>");
                out.print("<div style='height:20px;'><b>Bi&#x1EC3;n xe:&nbsp;&nbsp;</b><input id='Dev' type='text' size='23' maxlengt='32' class='textInput' onkeypress=\"return searchKeyPressed(event);\" onkeyup=\"javascript:jsmLoadDevSearch();\"><br/></div>");
                out.println("</td>");
                out.println("<td colspan='"+colspan+"' style=' height:20px; padding:0px 0px 5px 0px; float:left' align='left'>");

                //out.println("<table border='0' cellspacing='0' cellpadding='0' style='width:100%;position: absolute;top:65px;' ><tbody><tr>"); // 
                out.println("<table border='0' cellspacing='0' cellpadding='0' style='width:100%;' id='minhDevice'><tbody><tr>"); // [
                ...
                out.println("<input type='hidden' name='"+Calendar.PARM_RANGE_FR[0] +"' value=''/>");
                out.println("<input type='hidden' name='"+Calendar.PARM_RANGE_TO[0] +"' value=''/>");
                out.println("<input type='hidden' name='"+Calendar.PARM_TIMEZONE[0] +"' value=''/></div>");
                out.write("<table cellspacing='0' cellpadding='0' border='0'><tr>\n"); // [
                String mapTypeTitle = TrackMapFleetAbstract.this.getStringProperty(privLabel,PROP_mapTypeTitle,null);
                ...
                if (DeviceChooser.isDeviceChooserUseTable(privLabel)) {
                    ...
                    switch (dcSortBy) {
                        case DESCRIPTION : {
                            ...
                            out.write("<input id='"+ID_DEVICE_DESCR+"' name='"+ID_DEVICE_DESCR+"' type='text' value='"+selDesc+"' readonly size='20' class='textDrop' onclick=\""+chooserOnclick+"\">");
                            } break;
                        case NAME : {
                            ...
                            out.write("<input id='"+ID_DEVICE_ID   +"' name='"+parmDevGrp     +"' type='hidden' value='"+selId+"'>");
                            out.write("<input id='"+ID_DEVICE_DESCR+"' name='"+ID_DEVICE_DESCR+"' type='text' value='"+selName+"' readonly size='20' class='textDrop' onclick=\""+chooserOnclick+"\">");
                            } break;
                        case ID :
                        default : {
                            out.write("<input id='"+ID_DEVICE_ID   +"' name='"+parmDevGrp     +"' type='text' value='"+selId  +"' readonly size='14' class='textDrop' onclick=\""+chooserOnclick+"\">");
                            } break;
                    }
                    out.write("</td>");
                   // out.write("<td><img src='images/Pulldown.png' height='17' style='cursor:pointer;' onclick='javascript:trackMapShowSelector()'></td>");
                    ...
                    if (DeviceChooser.showSingleItemTextField(privLabel) && (dgList.size() == 1)) {
                        ...
                        out.write("</select>\n");
                        out.write("</td>\n");
                        out.print("<td style='padding-left: 12px;nowrap=\"nowrap\"'>Please call 0974008426, 0979305056, 01253235360, 0978421432 to help</td>");
                    }
                }
                // zoom region
                ...
                // Find Address
                if (TrackMapFleetAbstract.this.getBooleanProperty(privLabel,PrivateLabel.PROP_TrackMap_enableGeocode,false)) {
                ...
                out.println("<td style='"+mapCalTableStyle+"' colspan='2'>");

                //hienntd
               // out.print("<div style='position: absolute;top:0px;'>");
              //  out.println("<table cellspacing='0' cellpadding='0' border='0' style='width:100%; height:100%;position: absolute;top:100px;'  >");

                out.println("<table cellspacing='0' cellpadding='0' border='0' style='width:100%; height:100%;' id ='minhNVMap'>");

                out.println("<tr>");
                // hienntd add create devicelist
                if (showLocationDetails && mapProvider.isFeatureSupported(MapProvider.FEATURE_DETAIL_REPORT)) {
                String mapCellStyle1 = /* padding-right:5px; */ "width:273px;" + (mapAutoSize?" height:100%;":"");
                out.println("<td valign='top' id='"+ID_MAP_CONTROL+"' style='"+mapCellStyle1+" display:block;'>");
               // out.print("hoohoo");
                //out.print(CreateDevice(currAcct.getAccountID()));

               // out.print("<div style='height:30px;width:260px;'><b>Device ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input id='Dev' type='text' size='23' maxlengt='32' onkeypress=\"return searchKeyPressed(event);\" onkeyup=\"javascript:jsmLoadDevSearch();\"><br/></div>");

                out.write("<a class='trackMapDetailLocationControl'style='display:none;' id='"+MapProvider.ID_DETAIL_CONTROL+"' href=\"javascript:jsmLoadDevSearch()\">");
                out.write(i18n.getString("TrackMap.showLocationDetails","Show Location Details"));
                out.write("</a>");
                out.write("<div id='"+MapProvider.ID_DETAIL_TABLE+"' style='width:100%;margin-top:0px;height:99.7%; border:solid 1px white;border-radius:7px 7px 7px 7px;'></div>\n");
                out.print("</td>");
                ...
                if (!mapControlsOnLeft) { // mapOnLeft/controlsOnRight
                    ...
                    out.println("<td valign='top' id='mapcontrol' style='"+mapCellStyle+"'>");
                    MapDimension mapDim = new MapDimension(-1,mapProvider.getHeight());
                    mapProvider.writeMapCell(out, reqState, mapDim);
                    out.println("</td>\n");
             ...
             //   out.println("<td id='"+ID_MAP_CONTROL+"' class='mapControlCell' align='right' valign='top' style='"+controlCellPaddingStye+"'  >"); // style='height:100%;'>");
               //minhNV
                
               
                

                out.println("<td class='mapControlCell' align='left' valign='top' style='"+controlCellPaddingStye+"'>"); // style='height:100%;'>");


                out.print("<div id='Minhnvcontainer' style='display:none'>"+
     		   "<div id='Minhnvcontent'>"+
     		   "<div id='Minhnvbasic-modal'>"+
     		   "</div><div id=\"Minhnvbasic-modal-content\"></div><div style='display:none'><img src='images/x.png' alt='' /></div></div></div>");
                // Account/Device header
                out.println("<table border='0' cellspacing='0' cellpadding='0' style='display:none;'>"); //  style='height:100%;'>"); // {

                // Calendars
                out.println("\n");
                if (TrackMapFleetAbstract.this.showFromCalendar) {
                ...
                */
                ...
                // Legend
                if (TrackMapFleetAbstract.this.getBooleanProperty(privLabel,PrivateLabel.PROP_TrackMap_showLegend,true)) {
                    String keyStart = "%{";
                    String keyEnd   = "}";
               ...
               // }
                ...
                out.println("<script type='text/javascript' language='javascript'>$('#scrollbar1').tinyscrollbar(); </script>");
                out.println("</table>"); // ]
                ...
                /*NghiepN them popup hien trang he thong*/
              
                /*NghiepN them popup hien trang he thong*/
                
                DBCamera objcmr = new DBCamera();
                List<String[]> result = objcmr.getZone(currAcct.getAccountID().toString());
        	...
        	catch (Exception e)
        	{
                ...
                //MinhNV thÃªm áº£nh cho images bubble show
        		String tram;
                tram=  "<div id='page'>";
                
                tram +=" <div id='menu'>"; 
                tram+="<a onclick='javascript:full_screen();'>";
                 tram+= "<img src='./images/bubble/full_screen.png' title='To\u00E0n m\u00E0n h\u00ECnh' alt='' />";
                 tram +="</a>";

                 tram +="<a onclick='javascript:jsmControlToggleCollapse();'>";
                 tram +="<img src='./images/bubble/ALLTRACKER.png' title='Ẩn danh sách xe' alt=''/>";
                 tram +="</a>";
                 if(dem>0)
                 tram +="<a onclick='javascript:HideShowTram()'><img src='./images/bubble/POL.png' title='Ẩn danh sách trạm' alt=''/></a>";

                  //+"<img src='./images/bubble/CLEAR.png' title='Clear' alt='' />"
                 // +"<img src='./images/bubble/HYBRID.png' title='Hybrid' alt='' />"
                 // +"<img src='./images/bubble/TERRAIN.png' title='Terrain' alt='' />"
                 //  +"<img src='./images/bubble/ZOOM0.png' title='Zoom out' alt='' />"
                 // +"<img src='./images/bubble/ZOOM1.png' title='Zoom in' alt=''/>"
                 tram +="</div>";
                out.print(tram);
              
        		if(dem>0)
        		{
                	out.print( " <div id ='titleChooseTram'><table white='100%'><tr><td width='40'>  <img width='25px' style='margin-left:5px' src='images/chooseTram.png'></td><td style='color:white;font-weight:bold'>Ch&#x1ECD;n tr&#x1EA1;m</td></tr><tr><td colspan='2'><img src='images/ThanhNgangTram.png'/></td></tr></table></div><div class='chooseTram' id='chonTram'>"+chonTram(currAcct.getAccount().toString())+
                "</div>");  
        		}
                out.print( "<div class='speedo'> <img src='images/speedo/kim.png' id='image' alt='' class='anh'/> </div> <div id ='fuel'  class='XangMinhnv'><img src='images/speedo/kimXang.png' id='xang' alt='' class='kimXang'/> </div> "+"</div>");
        ...
        CommonServlet.writePageFrame(
            reqState,
            "javascript:trackMapOnLoad();mapDevicelistDetails();","javascript:trackMapOnUnload();",    // onLoad/onUnload
