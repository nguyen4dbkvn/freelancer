    ...
    implements ReportPresentation
{
        ...
        throws ReportException
    {
        ...
        /* report title row */
        {
            ...
            out.print("<tr><td colSpan='3' style='margin-bottom:10px;'><H1 class=\"rptTitle\">" + FilterText(rptTitle) + "</H1></td></tr>\n");
        }
        
        /* report subtitle row */
        {
            out.print("<tr style='margin-top:10px;margin-bottom:10px;height:65px;'>\n");
        ...
        out.print("<table class='"+tableClass+"' width='100%' cellspacing='1' cellpadding='0' border='0'>\n");
    ...
    {
    	//return WebPageAdaptor.FilterText(s);	//Display Vietnamese text in NCR Decimal format - VietH delete
    	return StringTools.replace(WebPageAdaptor.FilterText(s), "&amp;", "&");	//Display Vietnamese text in NCR Decimal format - VietH add
    }
            ...
            try {
                ...
                if (StringTools.isBlank(toEmail)) {
                    ...
                    SendMail.Attachment attach = new SendMail.Attachment(
                        ...
                        reportID + ".html", 
                        HTMLTools.MIME_HTML());
                    SendMail.send(frEmail, toEmail, subj, body.toString(), attach);
