    ...
    implements Constants
{
    ...
    private static String Minhnv_DMYtoYMD(String date)
    {
    	String[] temp = date.split("/");
    	return temp[2]+"/"+temp[1]+"/"+temp[0];
    }
        ...
        throws IOException
    {
        ...
        if (updateDriver) {
            ...
            String licenseExpire = Minhnv_DMYtoYMD(AttributeTools.getRequestString(request, PARM_LICENSE_EXPIRE,""));
            ...
            String ngaySinh   = Minhnv_DMYtoYMD(AttributeTools.getRequestString(request, "birthday" ,""));
            String driverID =AttributeTools.getRequestString(request,"d_driver", "");
          ...
          //String birthDate     = AttributeTools.getRequestString(request, PARM_BIRTHDATE     ,"");
            try {
                ...
                //birtdate
                //minhnv them
                if(!ngaySinh.equals(selDriver.getBirthdate()))
                { try{
                	selDriver.setBirthdate(GetDayNumber(ngaySinh));
                }catch(Exception e){
        ...
        if (_uiList) {
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //minhnv
                    out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+"Số điện thoại"+"</th>\n");
                    out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+"Loại bằng lái"+"</th>\n");
                    out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+"Số bằng lái"+"</th>\n");
                    out.write("   <th class='"+CommonServlet.CSS_ADMIN_TABLE_HEADER_COL    +"' nowrap>"+"Ngày hết hạn bằng lái"+"</th>\n");
                    ...
                    for (int u = 0; u < _driverList.size(); u++) {
                        ...
                        try {
                           ...
                           //minhnv
                                out.write("   <td class='"+CommonServlet.CSS_ADMIN_TABLE_BODY_COL    +"' nowrap>"+driver.getContactPhone()+"</td>\n");
                                out.write("   <td class='"+CommonServlet.CSS_ADMIN_TABLE_BODY_COL    +"' nowrap>"+driver.getLicenseType()+"</td>\n");
                                out.write("   <td class='"+CommonServlet.CSS_ADMIN_TABLE_BODY_COL    +"' nowrap>"+driver.getLicenseNumber()+"</td>\n");
                                out.write("   <td class='"+CommonServlet.CSS_ADMIN_TABLE_BODY_COL    +"' nowrap>"+Minhnv_YMDtoDMY(FormatDayNumber(driver.getLicenseExpire()))+"</td>\n");
                    ...
                    if (_allowView  ) { 
                        ...
                        out.write("<input type='submit' class='button' name='"+PARM_SUBMIT_VIEW+"' value='"+i18n.getString("DriverInfo.view","View")+"'>");
                        out.write("</td>\n"); 
                    }
                    if (_allowEdit  ) { 
                        out.write("<td style='padding-left:5px;'>");
                        out.write("<input type='submit' class='button' name='"+PARM_SUBMIT_EDIT+"' value='"+i18n.getString("DriverInfo.edit","Edit")+"'>");
                        out.write("</td>\n"); 
                    }
                    out.write("<td style='width:100%; text-align:right; padding-right:10px;'>");
                    if (_allowDelete) {
                        out.write("<input class='button' type='submit' name='"+PARM_SUBMIT_DEL+"' value='"+i18n.getString("DriverInfo.delete","Delete")+"' "+Onclick_ConfirmDelete(locale)+">");
                    } else {
                        out.write("&nbsp;"); 
                    }
                    out.write("</td>\n"); 
                    ...
                    out.write(" <input type='submit' class='button' name='"+PARM_SUBMIT_NEW+"' value='"+i18n.getString("DriverInfo.new","New")+"' style='margin-top:5px; margin-left:10px;'>\n");
                    out.write("</form>\n");
                    out.write("</div>\n");
                    out.write("<hr>\n");
                    }
                ...
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,RequestProperties.TRACK_BASE_URI(),PAGE_MENU_TOP);
                    ...
                    */
                    ...
                    out.println(FormRow_TextField(PARM_DRIVER_SELECT  , false  , i18n.getString("DriverInfo.driverID","Driver ID")+":"              , _selDriverID, 60, 90));
                    out.println(FormRow_TextField(PARM_DRIVER_NAME    , _uiEdit, i18n.getString("DriverInfo.driverName","Driver Name")+":"          , (_selDriver!=null)?_selDriver.getDescription()  :"", 60, 90));
                    out.println(FormRow_TextField(PARM_INFORMAL_NAME  , _uiEdit, i18n.getString("DriverInfo.informalName","Nickname")+":"           , (_selDriver!=null)?_selDriver.getDisplayName()  :"", 60, 90));
                    out.println(FormRow_TextField(PARM_CONTACT_PHONE  , _uiEdit, i18n.getString("DriverInfo.contactPhone","Contact Phone")+":"      , (_selDriver!=null)?_selDriver.getContactPhone() :"", 60, 90));
                    out.println(FormRow_TextField(PARM_CONTACT_EMAIL  , _uiEdit, i18n.getString("DriverInfo.contactEmail","Contact EMail")+":"      , (_selDriver!=null)?_selDriver.getContactEmail() :"", 60, 90));
                    out.println(FormRow_TextField(PARM_BADGE_ID       , _uiEdit, i18n.getString("DriverInfo.badgeID","Badge ID")+":"                , (_selDriver!=null)?_selDriver.getBadgeID()      :"", 60, 90));
                    out.println(FormRow_Separator());
                    out.println(FormRow_TextField(PARM_LICENSE_TYPE   , _uiEdit, i18n.getString("DriverInfo.licenseType","License Type")+":"        , (_selDriver!=null)?_selDriver.getLicenseType()  :"", 60, 90));
                    out.println(FormRow_TextField(PARM_LICENSE_NUMBER , _uiEdit, i18n.getString("DriverInfo.licenseNumber","License Number")+":"    , (_selDriver!=null)?_selDriver.getLicenseNumber():"",60, 90));
                   
                    try{
                    	 out.println(FormRow_TextField(PARM_LICENSE_EXPIRE , _uiEdit, i18n.getString("DriverInfo.licenseExpire","License Expiration")+":", (_selDriver!=null)?Minhnv_YMDtoDMY(FormatDayNumber(_selDriver.getLicenseExpire())):"",60, 90, i18n.getString("DriverInfo.dateYMD","(yyyy/mm/dd)")));
                    	}
                    catch(Exception e)
                    {}
                    
                  //  out.println(FormRow_TextField(PARM_LICENSE_EXPIRE , _uiEdit, i18n.getString("DriverInfo.licenseExpire","License Expiration")+":", (_selDriver!=null)?FormatDayNumber(_selDriver.getLicenseExpire()):"",60, 90, i18n.getString("DriverInfo.dateYMD","(yyyy/mm/dd)")));
                    out.println(FormRow_Separator());
                    ...
                    String allow ="";
                    String btnXem =AttributeTools.getRequestString(request,"c_subview", "");
                   // String btnUpdate =AttributeTools.getRequestString(request,PARM_SUBMIT_CHG, "");
                    String driverID =AttributeTools.getRequestString(request,"d_driver", "");
                    String ngaySinh =AttributeTools.getRequestString(request,"birthday", "");
                    String btnSua =AttributeTools.getRequestString(request,"c_subedit", "");
                    
                    String ns ="0";
                    DBCamera objcmr = new  DBCamera();
                    List<String[]> result = objcmr.selectDriverbyDriverID(driverID, currAcct.getAccountID());
                    try
                    {
                    ...
                    String bd="";
                    try{
                    bd=Minhnv_YMDtoDMY(FormatDayNumber(Long.parseLong(ns)).toString());
                    }catch(Exception e){}
                    out.print("<tr><td align='right' valign='top'><br/><hr/><br/>Ngày sinh:</td><td valign='top'><br/><hr/><br/><input type='text' id='birthday' "+allow+" class='textReadOnly' maxlenght='90' size='60' name='birthday' value='"+bd+"'/>"+i18n.getString("DriverInfo.dateYMD","(yyyy/mm/dd)")+"</td></tr>");
                    out.println("</table>");
                    ...
                    if (_uiEdit) {
                        out.write("<input type='submit' class='button' name='"+PARM_SUBMIT_CHG+"' value='"+"Change"+"'>\n");
                        out.write("<span style='padding-left:10px'>&nbsp;</span>\n");
                        out.write("<input type='button' class='button' name='"+PARM_BUTTON_CANCEL+"' value='"+i18n.getString("DriverInfo.cancel","Cancel")+"' onclick=\"javascript:openURL('"+editURL+"','_top');\">\n");
                    } else {
                        out.write("<input type='button' class='button' name='"+PARM_BUTTON_BACK+"' value='"+i18n.getString("DriverInfo.back","Back")+"' onclick=\"javascript:openURL('"+editURL+"','_top');\">\n");
                    }
