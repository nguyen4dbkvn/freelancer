    ...
    extends DeviceRecord<PendingCommands>
{
    ...
    private static DBField FieldInfo[] = {
        ...
        new DBField(FLD_sendState   , Integer.TYPE  , DBField.TYPE_UINT16     , "Send State"            , "key=true"),
        ...
        new DBField(FLD_commandArgs , String.class  , DBField.TYPE_STRING(128), "Command Args"          , "edit=2"),
        ...
        extends DeviceKey<PendingCommands>
    {
        ...
        public Key(String acctId, String devId, 
            ...
            super.setFieldValue(FLD_sendState  , sendState);
            super.setFieldValue(FLD_commandType, cmdType);
            super.setFieldValue(FLD_commandID  , cmdID);
        }
    ...
    **/
    public boolean sendCommand()
    {
        ...
        if (success) {
            ...
            deleted = this.setCommandSent(true, 0L);
        } else {
            Print.logError("Command failed: " + resp);
            deleted = this.setCommandSent(false, 0L);
        }
