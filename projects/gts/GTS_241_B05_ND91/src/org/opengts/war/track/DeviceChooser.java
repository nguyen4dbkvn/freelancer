...
public class DeviceChooser
{
    ...
    private static int    WIDTH_ID                    = 100;
    ...
    private static String deviceGetTableHTML(RequestProperties reqState, IDDescription list[], int DeviceChooserIDPosition, String searchVal)
    {
        ...
        append(html,"<table id='"+ID_DEVSELECT_TABLE+"' class='"+CLASS_TABLE_COLUMN_SORTABLE+"' cellspacing='0' cellpadding='0' >\n");
    ...
    public static void writeChooserDIV(PrintWriter out, RequestProperties reqState, IDDescription list[], String searchVal)
    {
        ...
        out.write("<div id='"+ID_CHOOSER_VIEW+"'  >\n");
        
        /* form */   
        if (DeviceChooser.isSearchEnabled(privLabel)) {
            out.write("<form id='"+ID_SEARCH_FORM+"' name='"+ID_SEARCH_FORM+"' method='GET' action=\"javascript:true;\" target='_self' style='padding-left:5px; background-color:#008EC1;color:white;'>\n"); // target='_top'
            ...
            out.write("<table class='"+CLASS_TABLE_COLUMN_SORTABLE+"' cellspacing='0' cellpadding='0'><tr class='"+CLASS_DEVSELECT_ROW_HEADER+"'>");
            if (idPos == IDPOS_NONE) {
        ...
        /* begin table */
        out.write("<div id='MinhNVScrollBar' ><div class='scrollbar'><div class='track'><div class='thumb'><div class='end'></div></div></div></div><div class='viewport'><div class='overview'>");
        out.write("<div id='"+ID_DIV_TABLE+"' class='"+CLASS_DEVSELECT_DIV_TABLE+"'>\n"); // FIX
        out.write("<table id='"+ID_DEVSELECT_TABLE+"' class='"+CLASS_TABLE_COLUMN_SORTABLE+"' cellspacing='0' cellpadding='0' >\n");
       ...
       // out.print("<script type='text/javascript'>$(document).ready(function() {$('#MinhNVScrollBar').tinyscrollbar();alert('hahaha');}); </script>");
        if (DeviceChooser.isSearchEnabled(privLabel)) {
