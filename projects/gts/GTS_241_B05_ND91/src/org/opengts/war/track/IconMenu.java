...
public class IconMenu
{
        ...
        throws IOException
    {
        ...
        out.print("<script>if(typeof(DD_belatedPNG) != 'undefined'){DD_belatedPNG.fix('#iconMenu IMG');} </script>");
    }
        ...
        throws IOException
    {
        ...
        for (String mgn : menuMap.keySet()) {
            ...
            for (WebPage wp : mg.getWebPageList(reqState)) {
                ...
                out.write("<td style='width:100px' class='"+classOff+"' title=\""+menuHelp+"\""+
                ...
                if (StringTools.isBlank(buttonImg)) {
                    ...
                    if (!StringTools.isBlank(iconImg)) {
                        out.write("<img class='"+menuIconImage+"' border='0' src='"+iconImg+"' size='65px'/><br/>");
                        out.write("  ");
                    }
