    ...
    implements Constants
{
        ...
        throws IOException
    {
       ...
       // Minhnv day la lay thoi gian cuoi cung
        try {
            ...
            if (!ListTools.isEmpty(evd)) {
              ...
              start  = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm ").format(new java.util.Date (evd[0].getTimestamp()*1000));
            }
        ...
        HTMLOutput HTML_CSS = new HTMLOutput() {
            public void write(PrintWriter out) throws IOException {
                ...
                String cssDir = TrackMap.this.getCssDirectory();
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput((mapAutoSize? CommonServlet.CSS_CONTENT_MAP_FULL : CommonServlet.CSS_CONTENT_MAP), m) {
            public void write(PrintWriter out) throws IOException {
                ...
                Date now1 = new Date();
                SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy/MM/dd 23:59");
                ...
                out.println("<tr>");
                out.println("<td colspan='"+colspan+"' style='width:21%; height:100%; padding:5px 0px 0px 10px;' valign='top'>");
                out.println("	<table border='0' cellspacing='0' cellpadding='0' style='width:100%; margin-top:10px; height:200px'><tbody><tr>"); // [

                // Device/Group selection
                out.println("		<td  style='font-size:9pt; height:19px;' colspan='2'>");
                ...
                out.print("						<td width='70px' ><b>"+mapTypeTitle+":</b>&nbsp;</td>");
                ...
                out.print  ("	<td width='70px' ><b>T&#x1EEB;:</b></td>\n");
                out.print  ("	<td >\n");
                out.print( "		<input id='Text1' name='tuNgay' type='text' class='textInput' style='width:135px;' onclick=\"displayCalendar(this,'yyyy/mm/dd hh:ii',this,true,'','Text1')\" value='"+start+"' /></td>");
                
                //lienptk
                //out.print("		<td style='margin-left:20px;'>\n");
				//  if (showUpdateAll) {
                //    out.println("<!-- 'Update All' -->");
                //    out.print  ("	<input class='button' id='"+ID_MAP_UPDATE_BTN+"' type='button' name='update' value='"+i18nUpdateBtn+"' title=\""+i18nUpdateTip+"\" onclick=\"javascript:trackMapClickedUpdateAll();\" style='margin-left:20px;width:80px;'>");
                //}
                //if (showUpdateLast) {
                ...
                //    out.print  ("	<input class='button' id='"+ID_MAP_LAST_BTN+"' type='button' name='update' value='"+i18nLastBtn+"' title=\""+i18nLastTip+"\" onclick=\"javascript:trackMapClickedUpdateLast();\">");
                //}
				//out.println("	</td>");
                ...
                if (!isFleet) {
					...
					out.print  ("<td width='70px' ><b>&#x0110;&#x1EBF;n:</b></td>\n");
                out.print  ("<td >\n");
                out.print( "<input id='Text2' name='denNgay'class='textInput' type='text' style='width:135px;' onclick=\"displayCalendar(this,'yyyy/mm/dd hh:ii',this,true,'','Text2')\" value='"+d1+"' /></td>");
                ...
                //    out.println("<!-- 'Auto Update' -->");
                 //   out.print  ("<input class='button' id='"+ID_MAP_AUTOUPDATE_BTN+"' type='button' name='autoUpdate' value='"+i18nAutoBtn+"' title=\""+i18nAutoTip+"\" onclick=\"javascript:trackMapClickedAutoUpdate();\" style='margin-left:20px;width:80px;'></form>");
                //}
					//hienntd dong
				 ...
				 out.print("<td style='margin-left:20px;' colspan='2'>\n");
					if (autoUpdateEnabled) {
	                    String i18nAutoBtn = i18n.getString("TrackMap.startAutoUpdate","Auto");
	                    String i18nAutoTip = i18n.getString("TrackMap.startAutoUpdate.tooltip","Click to start/stop auto-update");
	                    out.println("<!-- 'Auto Update' -->");
               ...
               if (showUpdateLast) {
				...
				out.println("	</td>");
				 out.println("</tr>");
                    ...
                    out.print  (  "<table cellpadding='0' cellspacing='0' border='0' style=''><tr>"); // {
                    out.print  (    "<td  style='width:70px; height:30px'>");
                    out.print  (       "<span title=\""+i18nInfoTip+"\" style='font-weight:bold'>");
                    out.print  (         "<label for='"+ID_MAP_SHOW_INFO+"'>"+i18nInfoText+"</label>&nbsp;</td><td style='margin-left:2px;'>" + Form_CheckBox(ID_MAP_SHOW_INFO,ID_MAP_SHOW_INFO,true,false,null,null));
                    out.print  (       "</span>");
                    out.print  (    "</td>");
				    out.print("</tr><tr>");
					 out.print  (    "<td  style='width:70px; font-weight:bold; height:30px'>"+i18nReplayBtn+"</td>");
                    out.print  (    "<td ><input id='"+ID_MAP_REPLAY_BTN+"' type='image' name='replayMap' src='images/Play20.png' title=\""+i18nReplayTip+"\"></td>");
                    out.println(  "</tr></table>"); // }
                    out.println("</form>");//hienntd end
                }
                ...
                if (showLocationDetails && mapProvider.isFeatureSupported(MapProvider.FEATURE_DETAIL_REPORT)) {
                   ...
                   /* out.write("<a class='trackMapDetailLocationControl' id='"+MapProvider.ID_DETAIL_CONTROL+"' href=\"javascript:mapProviderToggleDetails()\">");
                    ...
                    out.write("</a>");*/
                    out.print("<div onclick='javascript:getHanhTrinh();'><a href='#' class='trackMapDetailLocationControl'>Chi ti&#x1EBF;t h&#x00E0;nh tr&#x00EC;nh</a></div>");
               ...
               // out.println("<td>");
                // --- start map/control
                String mapCalTableStyle = "width:82%;" + (mapAutoSize?" height:100%;":"");
                out.println("<td style='"+mapCalTableStyle+"'>");
                out.println("	<table cellspacing='0' cellpadding='0' border='0' style='width:100%; height:100%; padding:10px 10px'>");
                out.println("		<tr>");
                ...
                out.println("\n<!-- Begin Map Controls -->");
                out.println("		<td id='"+ID_MAP_CONTROL+"' class='mapControlCell' align='left' valign='top' style='"+controlCellPaddingStye+"; display:none'>"); // style='height:100%;'>");
                ...
                if (TrackMap.this.showFromCalendar) {
                    ...
                    out.println("		<tr style='display:none'><td style='font-size:9pt; font-weight:bold; border-top: solid #CCCCCC 1px;'>"+i18n.getString("TrackMap.selectDates","Select Date Range:")+"</td></tr>");
...
//                    out.write(i18n.getString("TrackMap.showLocationDetails","Show Location Details"));
//                    out.write("</a>");*/
//                    out.print("<a href='javascript:getHanhTrinh();' class='trackMapDetailLocationControl'>Chi ti&#x1EBF;t h&#x00E0;nh tr&#x00EC;nh</a>");
//                    out.print("<div id='Minhnvcontainer' style='display:none'>"+
//                  		   "<div id='Minhnvcontent'>"+
//                  		   "<div id='Minhnvbasic-modal'>"+
//                  		   "</div><div id=\"Minhnvbasic-modal-content\"></div><div style='display:none'><img src='images/x.png' alt='' /></div></div></div>");
