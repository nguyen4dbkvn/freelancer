<?
	...
	$gsValuesNew['URL_SMS_GATEWAY_APP'] = "";
	$gsValuesNew['SMS_GATEWAY_TYPE'] = "";
	$gsValuesNew['SMS_GATEWAY_IDENTIFIER'] = "";
	$gsValuesNew['CONNECTION_TIMEOUT'] = @$gsValues['CONNECTION_TIMEOUT'];
	$gsValuesNew['URL_LOGIN'] = @$gsValues['URL_LOGIN'];
	$gsValuesNew['MAP_GOOGLE_KEY'] = "";
	$gsValuesNew['UNIT_OF_DISTANCE'] = "km";
	$gsValuesNew['UNIT_OF_CAPACITY'] = "l";
	$gsValuesNew['UNIT_OF_TEMPERATURE'] = "c";
	$gsValuesNew['CURRENCY'] = "EUR";
