		...
		<div class="block width33">
			<div class="container">
				<div class="row2">
					...
					<div class="width70"><select class="width100" id="dialog_dtc_object_list"></select></div>
				</div>
				<div class="row2">
					<div class="width30"><? echo $la['FILTER'];?></div>
					<div class="width70">
						<select class="width100" id="dialog_dtc_filter" onchange="switchHistoryReportsDateFilter('dtc');">
		...
		<div class="block width33">
			<div class="container">
				<div class="row2">
					...
					<div class="width15">
						<select class="width100" id="dialog_dtc_hour_from">
						<? include ("inc/inc_dt.hours.php"); ?>
						</select>
					</div>
					<div class="width2"></div>
					<div class="width15">
						<select class="width100" id="dialog_dtc_minute_from">
				...
				<div class="row2">
					...
					<div class="width2"></div>
					<div class="width15">
						<select class="width100" id="dialog_dtc_hour_to">
						<? include ("inc/inc_dt.hours.php"); ?>
						</select>
					</div>
					<div class="width2"></div>
					<div class="width15">
						<select class="width100" id="dialog_dtc_minute_to">
						<? include ("inc/inc_dt.minutes.php"); ?>
						</select>
					</div>
				</div>
