...
public class BaoCaoDongMo extends WebPageAdaptor implements Constants {
	...
	public String getMenuDescription(RequestProperties reqState,
		...
		I18N i18n = privLabel.getI18N(BaoCaoDongMo.class);
		return super._getMenuDescription(reqState,
				i18n.getString("BaoCaoDongMo.Menu", "Báo cáo đóng mở cửa"));
	}
	...
	public String getMenuHelp(RequestProperties reqState, String parentMenuName) {
		...
		return super._getMenuHelp(reqState,
				i18n.getString("BaoCaoDongMo.MenuHelp", "Báo cáo đóng mở cửa"));
	}
	...
	public String getNavigationDescription(RequestProperties reqState) {
		...
		return super._getNavigationDescription(reqState,
				i18n.getString("BaoCaoDongMo.NavDesc", "Báo cáo đóng mở cửa"));
	}

	public String getNavigationTab(RequestProperties reqState) {
		PrivateLabel privLabel = reqState.getPrivateLabel();
		I18N i18n = privLabel.getI18N(BaoCaoDongMo.class);
		return i18n.getString("BaoCaoDongMo.NavTab", "Báo cáo đóng mở cửa");
	}
	...
	public String LoadVuotTocDo(String Account, String tuNgay, String denNgay,
		...
		try {
			...
			strscr = strscr
					+ "<table  class='adminSelectTable_sortable' cellspacing='1' id='myTable' ><thead><tr  align='center'><th width='50px' class='adminTableHeaderCol_sort' >STT</th><th width='110px' class='adminTableHeaderCol_sort'>Lần đóng/mở</th><th width='200px' class='adminTableHeaderCol_sort'>Thời gian</th><th width='100px' class='adminTableHeaderCol_sort'>Trạng thái</th><th width='100px' class='adminTableHeaderCol_sort'>Tốc độ (km/h)</th><th class='adminTableHeaderCol_sort'>Địa điểm mở cửa</th></tr></thead>";
			...
			for (int k = 0; k < ed.length; k++) {
				...
				if (ed[k].getCua() != 1) {
					chuoi1 = chuoi1 + "<tr class =" + css + "><td>" + (k + 1)
							+ "</td><td> " + (k + 1) + "</td><td>" + day
							+ "</td><td>Mở</td><td>"
	...
	String pageMsg) throws IOException {
		...
		final I18N i18n = privLabel.getI18N(BaoCaoDongMo.class);
		...
		if (excel != "") {
			if (excel.equals("Export Excel")) {
				...
				response.setHeader("Content-Disposition",
						"attachment; filename=baoCaoDongMo_" + d);
				...
				ct.setCellStyle(cst);
				ct.setCellValue("BÁO CÁO MỞ CỬA");
				...
				h5.setCellValue("Địa điểm mở cửa");
				dem = dem + 1;
				...
				try {
					...
					for (int i = 0; i < ed.length; i++) {
						...
						r3.setCellStyle(csr);
						r3.setCellValue(DongMo(ed[i].getCua()));
		...
		HTMLOutput HTML_CSS = new HTMLOutput() {
			public void write(PrintWriter out) throws IOException {
				String cssDir = BaoCaoDongMo.this.getCssDirectory();
